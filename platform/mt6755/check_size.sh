...
# 232 KB Preloader    : 0x0020_1000 ~ 0x0023_B000
# 20 KB Preloader BSS : 0x0023_B000 ~ 0x0023_FFFF
PL_START_ADDR=0x00201000
PL_END_ADDR=0x0023B000
...
# Keep ROM size smaller than 232 KB (Move Preloader BSS into L2 Share SRAM)
# Keep ROM size smaller than 0x0023_B000 - 0x0020_1000 - Hash - Signature
HASH_SIZE=32
SIGN_SIZE=260
PL_MAX_ROM_SIZE=$((PL_END_ADDR - PL_START_ADDR - HASH_SIZE - SIGN_SIZE))
