...
#else
	pmic_config_interface(MT6351_PMIC_RG_FCHR_PU_EN_ADDR, 0x1, MT6351_PMIC_RG_FCHR_PU_EN_MASK, MT6351_PMIC_RG_FCHR_PU_EN_SHIFT);
#endif
#endif
...
bool mtk_detect_key(unsigned short key)  /* key: HW keycode */
{
	...
	{	/* Power key */
		...
		if(just_rst)
		{
			pmic_config_interface(MT6351_STRUP_CON12, 0x01, MT6351_PMIC_CLR_JUST_RST_MASK,  MT6351_PMIC_CLR_JUST_RST_SHIFT);
