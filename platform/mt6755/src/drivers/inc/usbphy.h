...
#define USB20_PHY_BASE		(SSUSB_SIFSLV_U2PHY_COM_BASE)
#define USB11_PHY_BASE			(USBSIF_BASE + 0x0800)
...
//USB20 PHY registers
#define USB20PHY_READ8(offset)		__raw_readb(USB20_PHY_BASE+offset)
#define USB20PHY_WRITE8(offset, value)	__raw_writeb(value, USB20_PHY_BASE+offset)
//USB11 PHY registers:
#define USB11PHY_READ32(offset)         __raw_readl((void *)(USB11_PHY_BASE+(offset)))
#define USB11PHY_READ8(offset)          __raw_readb((void *)(USB11_PHY_BASE+(offset)))
#define USB11PHY_WRITE8(offset, value)  __raw_writeb((u8)value, (void *)(USB11_PHY_BASE+(offset)))
