...
U8 gIs_ECO_IC, gOnly_09V_1PLL_Flow_Flag, gFAB_IC;
...
void CHECK_09V_1PLL_FLOW(void)
{
    ...
    seg_val = (seclib_get_devinfo_with_index(17) & 0xff);
    if((seg_val==0x42) || (seg_val==0x43) || (seg_val==0x46) ||\
	 (seg_val==0x4b) ||(seg_val==0xC2) || (seg_val==0xC6) ) {
...
#if __ETT__
    seg_val = Reg_Readl(0x1020627c) & 0xff;
...
//According to T28HPM_LJ_MEM_PLL_SettingWizard_Jade.xls
	...
	if((seg_val==0x42) || (seg_val==0x43) || (seg_val==0x46) || (seg_val==0x4b) ||\
	  (seg_val==0x41) || (seg_val==0x45) || (seg_val==0x2) || (seg_val==0x6) ||\
	(seg_val==0xC1) || (seg_val==0xC5) || (seg_val==0xC2) || (seg_val==0xC6)||(seg_val==0x40)) {
        //JADE minus : 1300/1666 setting
	...
	#if 0
        // ROSA : 1341/1866 settingi
	MEMPLL_N_INFO = 0x672b13b1; //26*0x672b13b1/2^24=2682.37 1pll:2682.37/4=670.6(1341MHz) 3pll:2682.375/0x2E=58.3125(REF_INT), 58.3125*2*(0x07+1)=933(1866MHz)
	MEMPLL_DIV = 0x2E;
	MEMPLLx_FBDIV = 0x07;
	MEMPLLx_BR = 0x02;
	MEMPLLx_BC = 0x03;
