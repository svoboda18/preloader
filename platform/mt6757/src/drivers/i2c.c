...
{
	/* TODO: Set GPIO for I2C_APPM */
	mt_set_gpio_pull_enable(GPIO47 | 0x80000000, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO47 | 0x80000000, GPIO_PULL_UP);

	mt_set_gpio_pull_enable(GPIO48 | 0x80000000, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO48 | 0x80000000, GPIO_PULL_UP);
