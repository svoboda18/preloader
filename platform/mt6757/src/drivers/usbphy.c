...
void mt_usb_phy_recover(void)
{
    ...
    USB_WRITE_FIELD32(U3D_SPLLC_XTALCTL3, E60802_RG_SSUSB_XTAL_RX_PWD_OFST, E60802_RG_SSUSB_XTAL_RX_PWD, 0x1);
    USB_WRITE_FIELD32(U3D_SPLLC_XTALCTL3, E60802_RG_SSUSB_FRC_XTAL_RX_PWD_OFST, E60802_RG_SSUSB_FRC_XTAL_RX_PWD, 0x1);
    USB_WRITE_FIELD32(U3D_U3PHYA_DA_REG36, RG_SSUSB_DA_SSUSB_PLL_BAND_OFST, RG_SSUSB_DA_SSUSB_PLL_BAND, 0x2D);
    USB_WRITE_FIELD32(U3D_PHYD_RXDET2, RG_SSUSB_RXDET_STB2_SET_P3_OFST, RG_SSUSB_RXDET_STB2_SET_P3, 0x10);
