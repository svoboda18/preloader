...
#define TX_TRIANGLE_EYE_WORKAROUND 1
...
#define LP4_CBT_NORMAL_MODE_DQ_PIN_MUX_WORKAROUND 1 //Normal mode can't use DQ to write VREFCA because pin mux over 0~5, so instead of MR12 
...
extern U8 u1MR12Value[CHANNEL_MAX][FSP_MAX];
