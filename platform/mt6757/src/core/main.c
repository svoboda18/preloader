...
#ifdef MTK_TEST_MODE2
    if (((internal_seclib_get_devinfo_with_index(30) & 0x000000E0) == 0x0) && (DRV_Reg32(APSW_VER) == 0x1)) {
#if defined (PMIC_CHIP_MT6355)
        enable_s75_test_mode(0x3);
#else
        enable_s75_test_mode(0x1);
#endif
    }
#endif
