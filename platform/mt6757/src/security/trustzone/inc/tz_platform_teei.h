...
#define MT_UART3_IRQ (0) /* NO UART3 */
#define MT_UART0_DAPC (76)
#define MT_UART1_DAPC (77)
#define MT_UART2_DAPC (78)
#define MT_UART3_DAPC (0) /* NO UART3 */
...
#define TEE_FCH_IRQ_NO		(289 + 32)
#define TEE_DRV_IRQ_NO		(290 + 32)
#define TEE_REV_IRQ_NO		(291 + 32)
#define TEE_DUMPER_IRQ_NO	(292 + 32)
