...
/* debug port control */
extern U32 seclib_dbgport_read_hw_config(void);
extern void seclib_dbgport_enable(bool bSecDebugEnable, bool bLock);
extern void seclib_dbgport_disable(bool bLock);
extern U32 seclib_dbgport_status(DBGPORT_STATUS *status);
extern U32 seclib_dbgport_dump(void);
