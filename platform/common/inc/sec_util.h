...
uint32_t sec_util_raw_read(uint64_t offset, uint8_t *buf, uint32_t size);
uint32_t sec_util_raw_write(uint64_t offset, uint8_t *buf, uint32_t size);
uint32_t sec_util_read_image (char *img_name, uint8_t *buf, uint64_t offset, uint32_t size);
