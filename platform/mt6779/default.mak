...
#For Infra_Reg SET/CLR
CFG_INFRA_RSVD3 	:=0x1000170C

#For SSPM
CFG_SSPM_MEMADDR	:=0x10400000
#For ATF
CFG_ATF_ROM_MEMADDR   :=0x00101000-0x800-0x240
...
#For SRAM Protection
CFG_NON_SECURE_SRAM_ADDR :=0x0011B000
CFG_NON_SECURE_SRAM_SIZE :=0x5000
CFG_EMI_MPU_LIB := 1
CFG_MBLOCK_LIB := 2
