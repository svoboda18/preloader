...
{
    //Common
    vIO32WriteFldAlign_All(DRAMC_REG_ZQCS, 0x0, ZQCS_ZQMASK_CGAR);
    ...
    vIO32WriteFldAlign_All(DDRPHY_B0_TX_MCK, 0x0, B0_TX_MCK_R_DM_TX_MCK_FRUN_B0);
    vIO32WriteFldAlign_All(DDRPHY_B1_DQ9, 0x1, B1_DQ9_RG_RX_ARDQS0_STBEN_RESETB_B1);
    vIO32WriteFldAlign_All(DDRPHY_B1_TX_MCK, 0x0, B1_TX_MCK_R_DM_TX_MCK_FRUN_B1);
    vIO32WriteFldAlign_All(DDRPHY_CA_DLL_ARPI1, 0x0, CA_DLL_ARPI1_RG_ARPISM_MCK_SEL_CA_REG_OPT);
    vIO32WriteFldAlign_All(DDRPHY_CA_TX_MCK, 0x11C0, CA_TX_MCK_R_DM_TX_MCK_FRUN_CA);
    vIO32WriteFldMulti_All(DDRPHY_DVFS_EMI_CLK, P_Fld(0x0, DVFS_EMI_CLK_RG_GATING_EMI_NEW)
        | P_Fld(0x1, DVFS_EMI_CLK_RG_52M_104M_SEL));
    ...
    vIO32WriteFldMulti_All(DDRPHY_MISC_CTRL1, P_Fld(0x1, MISC_CTRL1_R_DMDA_RRESETB_E)
        | P_Fld(0x0, MISC_CTRL1_R_WL_DOWNSP)
        | P_Fld(0x0, MISC_CTRL1_R_DMDRAMCLKEN1)
        | P_Fld(0x0, MISC_CTRL1_R_DMDRAMCLKEN0)
        | P_Fld(0x0, MISC_CTRL1_R_DMMUXCA_SEC)
        | P_Fld(0x1, MISC_CTRL1_R_DMDA_RRESETB_I)
        | P_Fld(0x1, MISC_CTRL1_R_DMRRESETB_I_OPT)
        | P_Fld(0x0, MISC_CTRL1_CK_BFE_DCM_EN)
        | P_Fld(0x0, MISC_CTRL1_R_DMARPICA_SW_UPDX)
        | P_Fld(0x0, MISC_CTRL1_R_DMPINMUX)
        | P_Fld(0x0, MISC_CTRL1_R_DMMUXCA)
        | P_Fld(0x0, MISC_CTRL1_R_DMMCTLPLL_CKSEL)
        | P_Fld(0x1, MISC_CTRL1_R_DM_TX_ARCMD_OE)
        | P_Fld(0x1, MISC_CTRL1_R_DM_TX_ARCLK_OE)
        | P_Fld(0x0, MISC_CTRL1_R_DMPHYRST));
    vIO32WriteFldMulti_All(DDRPHY_MISC_CTRL5, P_Fld(0x1, MISC_CTRL5_R_SRAM_SLEEPB)
        | P_Fld(0x1, MISC_CTRL5_R_SRAM_ISOINTB)
        | P_Fld(0x0, MISC_CTRL5_R_SRAM_HDEN)
        | P_Fld(0x0, MISC_CTRL5_R_SPM_SRAM_SLP_MSK)
        | P_Fld(0x0, MISC_CTRL5_MBIST_RSTB)
        | P_Fld(0x0, MISC_CTRL5_R_CS_MARK)
        | P_Fld(0x1, MISC_CTRL5_R_MBIST_HOLDB)
        | P_Fld(0x0, MISC_CTRL5_R_SLEEP_TEST)
        | P_Fld(0x0, MISC_CTRL5_R_SLEEP_INV)
        | P_Fld(0x0, MISC_CTRL5_R_SLEEP_R)
        | P_Fld(0x0, MISC_CTRL5_R_SLEEP_W)
        | P_Fld(0x0, MISC_CTRL5_R_MBIST_BACKGROUND)
        | P_Fld(0x0, MISC_CTRL5_R_MBIST_MODE)
        | P_Fld(0x1, MISC_CTRL5_R_MBIST_RPRSTB)
        | P_Fld(0x0, MISC_CTRL5_R_MBIST_RPREG_SEL)
        | P_Fld(0x0, MISC_CTRL5_R_MBIST_RPREG_LOAD)
        | P_Fld(0x1, MISC_CTRL5_R_USE_DEFAULT_DELSEL)
        | P_Fld(0x2A4, MISC_CTRL5_R_SRAM_DELSEL));
    vIO32WriteFldMulti_All(DDRPHY_CKMUX_SEL, P_Fld(0x1, CKMUX_SEL_R_PHYCTRLDCM)
        | P_Fld(0x1, CKMUX_SEL_R_PHYCTRLMUX));
    ...
    if(bEn)
    {
        vIO32WriteFldAlign_All(DRAMC_REG_CLKAR, 0x0, CLKAR_SEQCLKRUN);
    ...
    {
        vIO32WriteFldAlign_All(DRAMC_REG_CLKAR, 0x1, CLKAR_SEQCLKRUN);
        ...
        vIO32WriteFldAlign_All(DRAMC_REG_ZQCS, 0x1, ZQCS_ZQCS_MASK_SEL_CGAR);
        vIO32WriteFldAlign_All(DRAMC_REG_SHUCTRL, 0x1, SHUCTRL_DVFS_CG_OPT);
        vIO32WriteFldAlign_All(DRAMC_REG_PRE_TDQSCK1, 0x1, PRE_TDQSCK1_TXUIPI_CAL_CGAR);
...
{
    U8 u1ShuffleIdx;
    U32 u4DramcShuOffset = SHU_GRP_DRAMC_OFFSET*3; //SHU3 
    U32 u4DDRPhyShuOffset = SHU_GRP_DDRPHY_OFFSET*3; //SHU3
    ...
    for(u1ShuffleIdx = 0; u1ShuffleIdx<=DRAM_DFS_SRAM_MAX; u1ShuffleIdx++)//fill SHU1 of conf while (u1ShuffleIdx==DRAM_DFS_SRAM_MAX)
    {
        ...
        //Common
        vIO32WriteFldAlign_All(DDRPHY_SHU_B0_DQ7 + u4DDRPhyShuOffset, 0x0, SHU_B0_DQ7_R_DMARPI_CG_FB2DLL_DCM_EN_B0);
        vIO32WriteFldAlign_All(DDRPHY_SHU_B0_DQ8 + u4DDRPhyShuOffset, 0x1, SHU_B0_DQ8_R_RMRX_TOPHY_CG_IG_B0);
        vIO32WriteFldAlign_All(DDRPHY_SHU_B1_DQ7 + u4DDRPhyShuOffset, 0x0, SHU_B1_DQ7_R_DMARPI_CG_FB2DLL_DCM_EN_B1);
        vIO32WriteFldAlign_All(DDRPHY_SHU_B1_DQ8 + u4DDRPhyShuOffset, 0x1, SHU_B1_DQ8_R_RMRX_TOPHY_CG_IG_B1);
        vIO32WriteFldMulti_All(DDRPHY_SHU_CA_CMD7 + u4DDRPhyShuOffset, P_Fld(0x0, SHU_CA_CMD7_R_DMTX_ARPI_CG_CLK_NEW)
            | P_Fld(0x0, SHU_CA_CMD7_R_DMARPI_CG_FB2DLL_DCM_EN_CA));
        ...
        if(bEn)
        {
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_B0_DLL0 + u4DDRPhyShuOffset, 0x1, SHU_B0_DLL0_RG_ARPISM_MCK_SEL_B0_SHU);
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_B1_DLL0 + u4DDRPhyShuOffset, 0x1, SHU_B1_DLL0_RG_ARPISM_MCK_SEL_B1_SHU);
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_CA_DLL0 + u4DDRPhyShuOffset, 0x1, SHU_CA_DLL0_RG_ARPISM_MCK_SEL_CA_SHU);
        }
        else
        {
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_B0_DLL0 + u4DDRPhyShuOffset, 0x0, SHU_B0_DLL0_RG_ARPISM_MCK_SEL_B0_SHU);
            ...
            vIO32WriteFldMulti_All(DDRPHY_SHU_B1_DQ8 + u4DDRPhyShuOffset, P_Fld(0x1, SHU_B1_DQ8_R_DMRANK_CHG_PIPE_CG_IG_B1)
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_B1_DLL0 + u4DDRPhyShuOffset, 0x0, SHU_B1_DLL0_RG_ARPISM_MCK_SEL_B1_SHU);
            ...
            vIO32WriteFldAlign_All(DDRPHY_SHU_CA_DLL0 + u4DDRPhyShuOffset, 0x0, SHU_CA_DLL0_RG_ARPISM_MCK_SEL_CA_SHU);
        }
    }
    return;
}
