...
{
#if DIS_CH0_PULL
	/* Switch to GPIO mode (EH)*/
	/* 0x0:GPIO 0x1:I2C */
	/* SDA0[14:12] SCL0[2:0] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x30, (0x7 << 12) | (0x7 << 0),
		      (0 << 12) | (0 << 0));
	/* Disable pull-up (PU)*/
	/* 0x0:Disable 0x1:Enable */
	/* SDA0[9] SCL0[1] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x80, (0x1 << 9) | (0x1 << 1),
		      (0x0 << 9) | (0x0 << 1));
#endif

#if DIS_CH1_PULL
	/* SDA1[17:15] SCL1[5:3] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x30, (0x7 << 15) | (0x7 << 3),
		      (0 << 15) | (0 << 3));
	/* SDA1[10] SCL1[2] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x80, (0x1 << 10) | (0x1 << 2),
		      (0x0 << 10) | (0x0 << 2));
#endif

#if DIS_CH2_PULL
	/* SDA2[8:6] SCL2[2:0] */
        I2C_SET_REG32(IOCFG_BR_BASE + 0x30, (0x7 << 6) | (0x7 << 0),
		      (0 << 6) | (0 << 0));
	/* SDA2[17] SCL2[15] */
        I2C_SET_REG32(IOCFG_BR_BASE + 0xA0, (0x1 << 17) | (0x1 << 15),
		      (0x0 << 17) | (0x0 << 15));
#endif

#if DIS_CH3_PULL
	/* SDA3[20:18] SCL3[8:6] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x30, (0x7 << 18) | (0x7 << 6),
		      (0 << 18) | (0 << 6));
	/* SDA3[11] SCL3[3] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x80, (0x1 << 11) | (0x1 << 3),
		      (0x0 << 11) | (0x0 << 3));
#endif

#if DIS_CH4_PULL
	/* SDA4[11:9] SCL4[5:3] */
        I2C_SET_REG32(IOCFG_BR_BASE + 0x30, (0x7 << 9) | (0x7 << 3),
		      (0 << 9) | (0 << 3));
	/* SDA4[18] SCL4[16] */
        I2C_SET_REG32(IOCFG_BR_BASE + 0xA0, (0x1 << 18) | (0x1 << 16),
		      (0x0 << 18) | (0x0 << 16));
#endif

#if DIS_CH5_PULL
	/* SDA5[5:3] SCL5[2:0] */
        I2C_SET_REG32(IOCFG_LT_BASE + 0x20, (0x7 << 3) | (0x7 << 0),
		      (0 << 3) | (0 << 0));
	/* SDA5[25] SCL5[24] */
        I2C_SET_REG32(IOCFG_LT_BASE + 0x70, (0x1 << 25) | (0x1 << 24),
		      (0x0 << 25) | (0x0 << 24));
#endif

#if DIS_CH6_PULL
	/* PAD_EINT11 & EINT12 FUNC. 3 internal pullup disable */
	/* SDA6[8] SCL6[7] */
        //I2C_SET_REG32(IOCFG_BL_BASE + 0x90, (0x3 << 7), (0 << 7));
	/* SDA3[23:21] SCL3[11:9] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x30, (0x7 << 21) | (0x7 << 9),
		      (0 << 21) | (0 << 9));
	/* SDA3[14] SCL3[4] */
        I2C_SET_REG32(IOCFG_LM_BASE + 0x80, (0x1 << 12) | (0x1 << 4),
		      (0x0 << 12) | (0x0 << 4));
#endif
#if DIS_CH7_PULL
	/* SDA7[5:3] SCL7[2:0] */
        I2C_SET_REG32(IOCFG_LB_BASE + 0x10, (0x7 << 3) | 0x7 << 0),
        	      (0 << 3) | (0 << 0));
	/* SDA7[15] SCL7[14] */
	I2C_SET_REG32(IOCFG_LB_BASE + 0x40, (0x1 << 15) | (0x1 << 14),
		      (0x0 << 15) | (0x0 << 14));
#endif
...
static void internal_resister_setting(void)
{
	...
	/* SDA2[5:4] SCL2[1:0] */
	/* SDA4[7:6] SCL4[3:2] */
	I2C_SET_REG32(IOCFG_BR_BASE + 0xD0, 0xFF, 0xFF);
	/* SDA5[3:2] SCL5[1:0] */
	I2C_SET_REG32(IOCFG_LT_BASE + 0xB0, 0xF, 0xF);
	/* SDA0[9:8] SCL0[1:0] */
	/* SDA1[11:10] SCL1[3:2] */
	/* SDA3[13:12] SCL3[5:4] */
	/* SDA6[15:14] SCL6[7:6] */
	I2C_SET_REG32(IOCFG_LM_BASE + 0xD0, 0xFFFF, 0xFFFF);
	/* SDA7[3:2] SCL7[1:0] */
	I2C_SET_REG32(IOCFG_LB_BASE + 0x60, 0xF, 0xF);
}
#endif
...
#ifndef CONFIG_MT_I2C_FPGA_ENABLE
	/*swtich clock to PLL*/
	tmp = DRV_Reg32(MODULE_CLK_SEL_BASE);
	DRV_WriteReg32(MODULE_CLK_SEL_BASE, tmp | USE_PLL_MUX);
#endif

	/* Enable I2C2 & I2C3 & I2C4 &I2C7 buf/imm mode */
	tmp = DRV_Reg32(I2C2_BASE_SE + OFFSET_MULTI_DMA);
	mt_reg_sync_writel(SHADOW_REG_MODE | tmp,
                           I2C2_BASE_SE + OFFSET_MULTI_DMA);
	tmp = DRV_Reg32(I2C6_BASE_SE + OFFSET_MULTI_DMA);
	mt_reg_sync_writel(SHADOW_REG_MODE | tmp,
                           I2C6_BASE_SE + OFFSET_MULTI_DMA);
	tmp = DRV_Reg32(I2C4_BASE_SE + OFFSET_MULTI_DMA);
	mt_reg_sync_writel(SHADOW_REG_MODE | tmp,
                           I2C4_BASE_SE + OFFSET_MULTI_DMA);
	tmp = DRV_Reg32(I2C7_BASE_SE + OFFSET_MULTI_DMA);
	mt_reg_sync_writel(SHADOW_REG_MODE | tmp,
                           I2C7_BASE_SE + OFFSET_MULTI_DMA);
