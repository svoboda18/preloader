...
static void dump_charger_name(CHARGER_TYPE type)
{
	...
	case CHARGER_UNKNOWN:
		print("charger type: %d, CHARGER_UNKNOWN\n", type);
		break;
	case STANDARD_HOST:
		print("charger type: %d, Standard USB Host\n", type);
		break;
	case CHARGING_HOST:
		print("charger type: %d, Charging USB Host\n", type);
		break;
	case NONSTANDARD_CHARGER:
		print("charger type: %d, Non-standard Charger\n", type);
		break;
	case STANDARD_CHARGER:
		print("charger type: %d, Standard Charger\n", type);
		break;
	default:
		print("charger type: %d, Not Defined!!!\n", type);
		break;
	}
}
...
CHARGER_TYPE mt_charger_type_detection(void)
{
    ...
    {
        print("[mt_charger_type_detection] charger type: %d\r\n", g_ret);
    }
