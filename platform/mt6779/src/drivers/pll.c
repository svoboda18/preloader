...
void mt_pll_init(void)
{
    ...
    int i;
    unsigned int val = (seclib_get_devinfo_with_index(7) & 0xFF);
	...
	|| (val == 0x06) || (val == 0x60) || (val == 0x04) || (val == 0x20))
        DRV_WriteReg32(ADSPPLL_CON1, 0x80220000); //3536MHz
    else
...
//8: div1, A: div2, B: div4, 1D: div6
    ...
    DRV_WriteReg32(BUS_PLLDIV_CFG, (temp & 0xFFE1FFFF) | (0x0A << 17)); // [21:17] divsel: CPU clock divide by 2
    ...
    DRV_WriteReg32(CLK_CFG_0_SET, 0x00000102);//scp[18:16]: 26M, cksys_fmem[24]:26M
   
    DRV_WriteReg32(CLK_CFG_1_CLR, 0xFFFFFFFF);
    DRV_WriteReg32(CLK_CFG_1_SET, 0x07010106);
    
    DRV_WriteReg32(CLK_CFG_2_CLR, 0xFFFFFFFF);
    //DRV_WriteReg32(CLK_CFG_2_SET, 0x0f0f0e08);
    DRV_WriteReg32(CLK_CFG_2_SET, 0x0f0f0e06);//ccu[3:0]: 315M
    
    DRV_WriteReg32(CLK_CFG_3_CLR, 0xFFFFFFFF);
    DRV_WriteReg32(CLK_CFG_3_SET, 0x03010e0f);
    
    DRV_WriteReg32(CLK_CFG_4_CLR, 0xFFFFFFFF);
    //DRV_WriteReg32(CLK_CFG_4_SET, 0x02020202);
    DRV_WriteReg32(CLK_CFG_4_SET, 0x01010101);//camtg all 24M
    ...
    DRV_WriteReg32(CLK_CFG_6_SET, 0x00010004);//msdc30_1_sel[2:0]: msdcpll_d2, audio_sel[9:8]: 26M, pwrap_ulposc_sel[26:24]:osc_d10
    
    DRV_WriteReg32(CLK_CFG_7_CLR, 0xFFFFFFFF);
    //DRV_WriteReg32(CLK_CFG_7_SET, 0x01010401);
    DRV_WriteReg32(CLK_CFG_7_SET, 0x01010201);//sspm_sel[10:8]:273M
    ...
    DRV_WriteReg32(CLK_CFG_10_SET, 0x03030301);//aes: 364M
    ...
    DRV_WriteReg32(CLK_CFG_13_SET, 0x01020300);//camtg5[16:24]: 24M, pwm[0]:26M
