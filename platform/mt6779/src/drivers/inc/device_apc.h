...
#define DEVAPC_AO_INFRA_BASE        0x1001C000  // for INFRA/PERI
#define DEVAPC_AO_MD_BASE           0x10019000  // for MD
#define DEVAPC_AO_MM_BASE           0x1000E000  // for MM
...
#define MM_AP_HYP               (0x3 << 22)   // EMI MPU domain 11
