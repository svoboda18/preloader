...
#if (fcFOR_CHIP_ID == fcLafite)
#define MPLL_PWR_CON0 (APMIXED_BASE + 0x029c)
...
#define DRAMC_REG_DRAMC_LOOP_BAK_ADR (DRAMC_NAO_BASE_ADDRESS + 0x0504)
    #define DRAMC_LOOP_BAK_ADR_TEST_WR_ROW_ADR Fld(17,15,AC_MSKDW)//[31:15]
    #define DRAMC_LOOP_BAK_ADR_TEST_WR_COL_ADR Fld(11,4,AC_MSKW10)//[14:4]
    #define DRAMC_LOOP_BAK_ADR_TEST_WR_BK_ADR Fld(3,1,AC_MSKB0)//[3:1]
    #define DRAMC_LOOP_BAK_ADR_LOOP_BAK_ADR_CMP_FAIL Fld(1,0,AC_MSKB0)//[0:0]
