...
void DDRPhyPLLSetting(DRAMC_CTX_T *p)
{
    ...
    if ((u1CurrShuLevel == SRAM_SHU4) || (u1CurrShuLevel == SRAM_SHU6) || (u1CurrShuLevel == SRAM_SHU8) || (u1CurrShuLevel == SRAM_SHU9))
    {
...
void DDRPhyReservedRGSetting(DRAMC_CTX_T *p)
{
    ...
    if((p->frequency > 1600) && (gDramcSwImpedanceResult[0][DRVP] > 0))
    {
        ...
        vIO32WriteFldAlign_All(DDRPHY_SHU_B1_DLL1, 0x1, SHU_B0_DLL1_RG_TX_PRE_EN_B0); 
...
static DRAM_STATUS_T UpdateInitialSettings_LP4(DRAMC_CTX_T *p)
{
    ...
    //Sylvia MP setting should set CKECTRL_CKELCKFIX as 0 to rollback to M17 
    //Eiger review by CF Chang
    ...
    vIO32WriteFldMulti(DRAMC_REG_SHU_SELPH_CA7, P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA0) |
                                                               P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA1) |
                                                               P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA2) |
                                                               P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA3) |
                                                               P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA4) |
                                                               P_Fld(u1CaUI, SHU_SELPH_CA7_DLY_RA5));

    // Note: CKE UI must sync CA UI (CA and CKE delay circuit are same) @Lin-Yi
    // To avoid tXP timing margin issue
    vIO32WriteFldAlign(DRAMC_REG_SHU_SELPH_CA5, u1CaUI, SHU_SELPH_CA5_DLY_CKE);
    vIO32WriteFldAlign(DRAMC_REG_SHU_SELPH_CA6, u1CaUI, SHU_SELPH_CA6_DLY_CKE1);
...
static void LegacyGatingDlyLP4_DDR800(DRAMC_CTX_T *p)
{
    ...
    {
        //DQSINCTL=7, DQSG0 = 0x0
        //DQSINCTL=5, DQSG0 = 0x1
        vIO32WriteFldMulti(DRAMC_REG_SHURK0_SELPH_DQSG0, P_Fld(0x1, SHURK0_SELPH_DQSG0_TX_DLY_DQS1_GATED_P1)
                    | P_Fld(0x1, SHURK0_SELPH_DQSG0_TX_DLY_DQS1_GATED)
                    | P_Fld(0x1, SHURK0_SELPH_DQSG0_TX_DLY_DQS0_GATED_P1)
                    | P_Fld(0x1, SHURK0_SELPH_DQSG0_TX_DLY_DQS0_GATED));
        vIO32WriteFldMulti(DRAMC_REG_SHURK0_SELPH_DQSG1, P_Fld(0x6, SHURK0_SELPH_DQSG1_REG_DLY_DQS1_GATED_P1)
    ...
    else
    {
        //DQSINCTL=7, DQSG0 = 0x0, 
        //DQSINCTL=5, DQSG0 = 0x1
        vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG0, P_Fld(0x1, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS1_GATED_P1)
                    | P_Fld(0x1, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS1_GATED)
                    | P_Fld(0x1, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED_P1)
                    | P_Fld(0x1, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED));
        vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG1, P_Fld(0x7, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED_P1)
                    | P_Fld(0x5, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED)
                    | P_Fld(0x7, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED_P1)
                    | P_Fld(0x5, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED));
    }
...
//Gating PI
    ...
    {
        vIO32WriteFldMulti(DRAMC_REG_SHURK0_DQSIEN, P_Fld(0xe, SHURK0_DQSIEN_R0DQS1IEN)
                    | P_Fld(0xc, SHURK0_DQSIEN_R0DQS0IEN));
        vIO32WriteFldMulti(DRAMC_REG_SHURK1_DQSIEN, P_Fld(0x1e, SHURK1_DQSIEN_R1DQS1IEN)
                    | P_Fld(0x1e, SHURK1_DQSIEN_R1DQS0IEN));
    }
    else
    {
...
static void LegacyGatingDlyLP4_DDR1600(DRAMC_CTX_T *p)
{
    ...
    if (vGet_Dram_CBT_Mode(p) == CBT_BYTE_MODE1)
    {
        ...
        else
        {
            vIO32WriteFldMulti(DRAMC_REG_SHURK0_SELPH_DQSG0, P_Fld(0x2, SHURK0_SELPH_DQSG0_TX_DLY_DQS1_GATED_P1)
                        ...
                        | P_Fld(0x2, SHURK0_SELPH_DQSG0_TX_DLY_DQS0_GATED_P1)
                        | P_Fld(0x2, SHURK0_SELPH_DQSG0_TX_DLY_DQS0_GATED));
            vIO32WriteFldMulti(DRAMC_REG_SHURK0_SELPH_DQSG1, P_Fld(0x5, SHURK0_SELPH_DQSG1_REG_DLY_DQS1_GATED_P1)
                        | P_Fld(0x1, SHURK0_SELPH_DQSG1_REG_DLY_DQS1_GATED)
                        | P_Fld(0x4, SHURK0_SELPH_DQSG1_REG_DLY_DQS0_GATED_P1)
                        | P_Fld(0x0, SHURK0_SELPH_DQSG1_REG_DLY_DQS0_GATED));
        }
    ...
    if (vGet_Dram_CBT_Mode(p) == CBT_BYTE_MODE1)
    {
        if ((p->dram_cbt_mode[RANK_0] == CBT_BYTE_MODE1) && (p->dram_cbt_mode[RANK_1] == CBT_BYTE_MODE1)) // RK1 gating for byte mode
        {
            vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG0, P_Fld(0x2, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS1_GATED_P1)
                        ...
                        | P_Fld(0x2, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED_P1)
                        | P_Fld(0x2, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED));
            vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG1, P_Fld(0x6, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED_P1)
                        | P_Fld(0x2, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED)
                        | P_Fld(0x7, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED_P1)
    ...
    else
    {
        if (vGet_Div_Mode(p) == DIV4_MODE)
        {
                vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG0, P_Fld(0x2, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS1_GATED_P1)
                            ...
                            | P_Fld(0x2, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED_P1)
                            | P_Fld(0x1, SHURK1_SELPH_DQSG0_TX_DLY_R1DQS0_GATED));
                vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG1, P_Fld(0x1, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED_P1)
                            | P_Fld(0x7, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED)
                            | P_Fld(0x1, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED_P1)
                            | P_Fld(0x7, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED));
        }
    ...
    if (vGet_Div_Mode(p) == DIV4_MODE)
    {
        ...
        vIO32WriteFldMulti(DRAMC_REG_SHURK0_DQSIEN, P_Fld(0x0, SHURK0_DQSIEN_R0DQS3IEN)
                    | P_Fld(0xb, SHURK0_DQSIEN_R0DQS2IEN)
                    | P_Fld(0x0, SHURK0_DQSIEN_R0DQS1IEN)
                    | P_Fld(0xb, SHURK0_DQSIEN_R0DQS0IEN));
        vIO32WriteFldMulti(DRAMC_REG_SHURK1_DQSIEN, P_Fld(0x1, SHURK1_DQSIEN_R1DQS3IEN)
                    | P_Fld(0x1, SHURK1_DQSIEN_R1DQS2IEN)
                    | P_Fld(0x1, SHURK1_DQSIEN_R1DQS1IEN)
                    | P_Fld(0x1, SHURK1_DQSIEN_R1DQS0IEN));
    }
    else
    {
        ...
        if (vGet_Dram_CBT_Mode(p) == CBT_BYTE_MODE1)
        {
            ...
            {
                vIO32WriteFldMulti(DRAMC_REG_SHURK0_DQSIEN, P_Fld(0x0, SHURK0_DQSIEN_R0DQS1IEN)
                            | P_Fld(0xa, SHURK0_DQSIEN_R0DQS0IEN));
                vIO32WriteFldMulti(DRAMC_REG_SHURK1_DQSIEN, P_Fld(0x16, SHURK1_DQSIEN_R1DQS1IEN)
                            | P_Fld(0xc, SHURK1_DQSIEN_R1DQS0IEN));
            }
            else if ((p->dram_cbt_mode[RANK_0] == CBT_BYTE_MODE1) && (p->dram_cbt_mode[RANK_1] == CBT_NORMAL_MODE)) // DV sim mixed mode
            {
                vIO32WriteFldMulti(DRAMC_REG_SHURK0_DQSIEN, P_Fld(0x1e, SHURK0_DQSIEN_R0DQS1IEN)
                            | P_Fld(0xa, SHURK0_DQSIEN_R0DQS0IEN));
                vIO32WriteFldMulti(DRAMC_REG_SHURK1_DQSIEN, P_Fld(0xc, SHURK1_DQSIEN_R1DQS1IEN)
                            | P_Fld(0xc, SHURK1_DQSIEN_R1DQS0IEN));
            }
...
{
    U8 ucR0GatingMCK = 0, ucR0GatingUI = 0, ucR0GatingPI = 0;
    U8 ucR0GatingP1MCK = 0, ucR0GatingP1UI = 0;
    U8 ucR1GatingMCK = 0, ucR1GatingUI = 0, ucR1GatingPI = 0;
    U8 ucR1GatingP1MCK = 0, ucR1GatingP1UI = 0;
    ...
    //Gating RK0 UI
    vIO32WriteFldMulti(DRAMC_REG_SHURK0_SELPH_DQSG1, P_Fld(ucR0GatingP1UI, SHURK0_SELPH_DQSG1_REG_DLY_DQS1_GATED_P1)
                | P_Fld(ucR0GatingUI, SHURK0_SELPH_DQSG1_REG_DLY_DQS1_GATED)
                | P_Fld(ucR0GatingP1UI, SHURK0_SELPH_DQSG1_REG_DLY_DQS0_GATED_P1)
                | P_Fld(ucR0GatingUI, SHURK0_SELPH_DQSG1_REG_DLY_DQS0_GATED));
    ...
    //Gating RK1 UI
    vIO32WriteFldMulti(DRAMC_REG_SHURK1_SELPH_DQSG1, P_Fld(ucR1GatingP1UI, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED_P1)
                | P_Fld(ucR1GatingUI, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED)
                | P_Fld(ucR1GatingP1UI, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS0_GATED_P1)
                | P_Fld(ucR1GatingUI, SHURK1_SELPH_DQSG1_REG_DLY_R1DQS1_GATED));

    //Gating RK0 PI
    vIO32WriteFldMulti(DRAMC_REG_SHURK0_DQSIEN, P_Fld(0x0, SHURK0_DQSIEN_R0DQS3IEN)
                | P_Fld(0x0, SHURK0_DQSIEN_R0DQS2IEN)
                | P_Fld(ucR0GatingPI, SHURK0_DQSIEN_R0DQS1IEN)
                | P_Fld(ucR0GatingPI, SHURK0_DQSIEN_R0DQS0IEN));

    //Gating RK1 PI
    vIO32WriteFldMulti(DRAMC_REG_SHURK1_DQSIEN, P_Fld(0x0, SHURK1_DQSIEN_R1DQS3IEN)
                | P_Fld(0x0, SHURK1_DQSIEN_R1DQS2IEN)
                | P_Fld(ucR1GatingPI, SHURK1_DQSIEN_R1DQS1IEN)
                | P_Fld(ucR1GatingPI, SHURK1_DQSIEN_R1DQS0IEN));
}
...
{
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ2, P_Fld(0x0, SHU_R0_B0_DQ2_RK0_RX_ARDQ1_R_DLY_B0)
                | P_Fld(0x0, SHU_R0_B0_DQ2_RK0_RX_ARDQ0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ3, P_Fld(0x0, SHU_R0_B0_DQ3_RK0_RX_ARDQ3_R_DLY_B0)
                | P_Fld(0x0, SHU_R0_B0_DQ3_RK0_RX_ARDQ2_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ4, P_Fld(0x0, SHU_R0_B0_DQ4_RK0_RX_ARDQ5_R_DLY_B0)
                | P_Fld(0x0, SHU_R0_B0_DQ4_RK0_RX_ARDQ4_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ5, P_Fld(0x0, SHU_R0_B0_DQ5_RK0_RX_ARDQ7_R_DLY_B0)
                | P_Fld(0x0, SHU_R0_B0_DQ5_RK0_RX_ARDQ6_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ6, P_Fld(0x26, SHU_R0_B0_DQ6_RK0_RX_ARDQS0_R_DLY_B0)
                | P_Fld(0x0, SHU_R0_B0_DQ6_RK0_RX_ARDQM0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ2, P_Fld(0x0, SHU_R0_B1_DQ2_RK0_RX_ARDQ1_R_DLY_B1)
                | P_Fld(0x0, SHU_R0_B1_DQ2_RK0_RX_ARDQ0_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ3, P_Fld(0x0, SHU_R0_B1_DQ3_RK0_RX_ARDQ3_R_DLY_B1)
                | P_Fld(0x0, SHU_R0_B1_DQ3_RK0_RX_ARDQ2_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ4, P_Fld(0x0, SHU_R0_B1_DQ4_RK0_RX_ARDQ5_R_DLY_B1)
                | P_Fld(0x0, SHU_R0_B1_DQ4_RK0_RX_ARDQ4_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ5, P_Fld(0x0, SHU_R0_B1_DQ5_RK0_RX_ARDQ7_R_DLY_B1)
                | P_Fld(0x0, SHU_R0_B1_DQ5_RK0_RX_ARDQ6_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ6, P_Fld(0x26, SHU_R0_B1_DQ6_RK0_RX_ARDQS0_R_DLY_B1)
                | P_Fld(0x0, SHU_R0_B1_DQ6_RK0_RX_ARDQM0_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ2, P_Fld(0x0, SHU_R1_B0_DQ2_RK1_RX_ARDQ1_R_DLY_B0)
                | P_Fld(0x0, SHU_R1_B0_DQ2_RK1_RX_ARDQ0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ3, P_Fld(0x0, SHU_R1_B0_DQ3_RK1_RX_ARDQ3_R_DLY_B0)
                | P_Fld(0x0, SHU_R1_B0_DQ3_RK1_RX_ARDQ2_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ4, P_Fld(0x0, SHU_R1_B0_DQ4_RK1_RX_ARDQ5_R_DLY_B0)
                | P_Fld(0x0, SHU_R1_B0_DQ4_RK1_RX_ARDQ4_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ5, P_Fld(0x0, SHU_R1_B0_DQ5_RK1_RX_ARDQ7_R_DLY_B0)
                | P_Fld(0x0, SHU_R1_B0_DQ5_RK1_RX_ARDQ6_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ6, P_Fld(0x26, SHU_R1_B0_DQ6_RK1_RX_ARDQS0_R_DLY_B0)
                | P_Fld(0x0, SHU_R1_B0_DQ6_RK1_RX_ARDQM0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ2, P_Fld(0x0, SHU_R1_B1_DQ2_RK1_RX_ARDQ1_R_DLY_B1)
                | P_Fld(0x0, SHU_R1_B1_DQ2_RK1_RX_ARDQ0_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ3, P_Fld(0x0, SHU_R1_B1_DQ3_RK1_RX_ARDQ3_R_DLY_B1)
                | P_Fld(0x0, SHU_R1_B1_DQ3_RK1_RX_ARDQ2_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ4, P_Fld(0x0, SHU_R1_B1_DQ4_RK1_RX_ARDQ5_R_DLY_B1)
                | P_Fld(0x0, SHU_R1_B1_DQ4_RK1_RX_ARDQ4_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ5, P_Fld(0x0, SHU_R1_B1_DQ5_RK1_RX_ARDQ7_R_DLY_B1)
                | P_Fld(0x0, SHU_R1_B1_DQ5_RK1_RX_ARDQ6_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ6, P_Fld(0x26, SHU_R1_B1_DQ6_RK1_RX_ARDQS0_R_DLY_B1)
                | P_Fld(0x0, SHU_R1_B1_DQ6_RK1_RX_ARDQM0_R_DLY_B1));
}
...
static void LegacyRxDly_LP4_DDR1600(DRAMC_CTX_T *p)
{
    if (vGet_Dram_CBT_Mode(p) == CBT_BYTE_MODE1)
    {
        ...
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ3, P_Fld(0x0, SHU_R0_B0_DQ3_RK0_RX_ARDQ3_R_DLY_B0)
                    | P_Fld(0x0, SHU_R0_B0_DQ3_RK0_RX_ARDQ2_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ4, P_Fld(0x2, SHU_R0_B0_DQ4_RK0_RX_ARDQ5_R_DLY_B0)
                    | P_Fld(0x0, SHU_R0_B0_DQ4_RK0_RX_ARDQ4_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ5, P_Fld(0x0, SHU_R0_B0_DQ5_RK0_RX_ARDQ7_R_DLY_B0)
                    | P_Fld(0x2, SHU_R0_B0_DQ5_RK0_RX_ARDQ6_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ6, P_Fld(0x7, SHU_R0_B0_DQ6_RK0_RX_ARDQS0_R_DLY_B0)
                    | P_Fld(0x0, SHU_R0_B0_DQ6_RK0_RX_ARDQM0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ2, P_Fld(0x0, SHU_R0_B1_DQ2_RK0_RX_ARDQ1_R_DLY_B1)
                    | P_Fld(0x0, SHU_R0_B1_DQ2_RK0_RX_ARDQ0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ3, P_Fld(0x0, SHU_R0_B1_DQ3_RK0_RX_ARDQ3_R_DLY_B1)
                    | P_Fld(0x0, SHU_R0_B1_DQ3_RK0_RX_ARDQ2_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ4, P_Fld(0x2, SHU_R0_B1_DQ4_RK0_RX_ARDQ5_R_DLY_B1)
                    | P_Fld(0x0, SHU_R0_B1_DQ4_RK0_RX_ARDQ4_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ5, P_Fld(0x0, SHU_R0_B1_DQ5_RK0_RX_ARDQ7_R_DLY_B1)
                    | P_Fld(0x2, SHU_R0_B1_DQ5_RK0_RX_ARDQ6_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ6, P_Fld(0x7, SHU_R0_B1_DQ6_RK0_RX_ARDQS0_R_DLY_B1)
                    | P_Fld(0x0, SHU_R0_B1_DQ6_RK0_RX_ARDQM0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ2, P_Fld(0x0, SHU_R1_B0_DQ2_RK1_RX_ARDQ1_R_DLY_B0)
                    | P_Fld(0x0, SHU_R1_B0_DQ2_RK1_RX_ARDQ0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ3, P_Fld(0x0, SHU_R1_B0_DQ3_RK1_RX_ARDQ3_R_DLY_B0)
        ...
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ5, P_Fld(0x0, SHU_R1_B0_DQ5_RK1_RX_ARDQ7_R_DLY_B0)
                    | P_Fld(0x0, SHU_R1_B0_DQ5_RK1_RX_ARDQ6_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ6, P_Fld(0x5, SHU_R1_B0_DQ6_RK1_RX_ARDQS0_R_DLY_B0)
                    | P_Fld(0x0, SHU_R1_B0_DQ6_RK1_RX_ARDQM0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ2, P_Fld(0x0, SHU_R1_B1_DQ2_RK1_RX_ARDQ1_R_DLY_B1)
                    | P_Fld(0x0, SHU_R1_B1_DQ2_RK1_RX_ARDQ0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ3, P_Fld(0x0, SHU_R1_B1_DQ3_RK1_RX_ARDQ3_R_DLY_B1)
        ...
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ5, P_Fld(0x0, SHU_R1_B1_DQ5_RK1_RX_ARDQ7_R_DLY_B1)
                    | P_Fld(0x0, SHU_R1_B1_DQ5_RK1_RX_ARDQ6_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ6, P_Fld(0x5, SHU_R1_B1_DQ6_RK1_RX_ARDQS0_R_DLY_B1)
                    | P_Fld(0x0, SHU_R1_B1_DQ6_RK1_RX_ARDQM0_R_DLY_B1));
    }
    else
    {
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ2, P_Fld(0x4, SHU_R0_B0_DQ2_RK0_RX_ARDQ1_R_DLY_B0)
                    | P_Fld(0x4, SHU_R0_B0_DQ2_RK0_RX_ARDQ0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ3, P_Fld(0x4, SHU_R0_B0_DQ3_RK0_RX_ARDQ3_R_DLY_B0)
                    | P_Fld(0x4, SHU_R0_B0_DQ3_RK0_RX_ARDQ2_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ4, P_Fld(0x4, SHU_R0_B0_DQ4_RK0_RX_ARDQ5_R_DLY_B0)
                    | P_Fld(0x4, SHU_R0_B0_DQ4_RK0_RX_ARDQ4_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ5, P_Fld(0x4, SHU_R0_B0_DQ5_RK0_RX_ARDQ7_R_DLY_B0)
                    | P_Fld(0x4, SHU_R0_B0_DQ5_RK0_RX_ARDQ6_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ6, P_Fld(0x15, SHU_R0_B0_DQ6_RK0_RX_ARDQS0_R_DLY_B0)
                    | P_Fld(0x4, SHU_R0_B0_DQ6_RK0_RX_ARDQM0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ2, P_Fld(0x4, SHU_R0_B1_DQ2_RK0_RX_ARDQ1_R_DLY_B1)
                    | P_Fld(0x4, SHU_R0_B1_DQ2_RK0_RX_ARDQ0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ3, P_Fld(0x4, SHU_R0_B1_DQ3_RK0_RX_ARDQ3_R_DLY_B1)
                    | P_Fld(0x4, SHU_R0_B1_DQ3_RK0_RX_ARDQ2_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ4, P_Fld(0x4, SHU_R0_B1_DQ4_RK0_RX_ARDQ5_R_DLY_B1)
                    | P_Fld(0x4, SHU_R0_B1_DQ4_RK0_RX_ARDQ4_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ5, P_Fld(0x4, SHU_R0_B1_DQ5_RK0_RX_ARDQ7_R_DLY_B1)
                    | P_Fld(0x4, SHU_R0_B1_DQ5_RK0_RX_ARDQ6_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ6, P_Fld(0x15, SHU_R0_B1_DQ6_RK0_RX_ARDQS0_R_DLY_B1)
                    | P_Fld(0x4, SHU_R0_B1_DQ6_RK0_RX_ARDQM0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ2, P_Fld(0x5, SHU_R1_B0_DQ2_RK1_RX_ARDQ1_R_DLY_B0)
                    | P_Fld(0x5, SHU_R1_B0_DQ2_RK1_RX_ARDQ0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ3, P_Fld(0x5, SHU_R1_B0_DQ3_RK1_RX_ARDQ3_R_DLY_B0)
                    | P_Fld(0x5, SHU_R1_B0_DQ3_RK1_RX_ARDQ2_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ4, P_Fld(0x5, SHU_R1_B0_DQ4_RK1_RX_ARDQ5_R_DLY_B0)
                    | P_Fld(0x5, SHU_R1_B0_DQ4_RK1_RX_ARDQ4_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ5, P_Fld(0x5, SHU_R1_B0_DQ5_RK1_RX_ARDQ7_R_DLY_B0)
                    | P_Fld(0x5, SHU_R1_B0_DQ5_RK1_RX_ARDQ6_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ6, P_Fld(0x16, SHU_R1_B0_DQ6_RK1_RX_ARDQS0_R_DLY_B0)
                    | P_Fld(0x5, SHU_R1_B0_DQ6_RK1_RX_ARDQM0_R_DLY_B0));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ2, P_Fld(0x5, SHU_R1_B1_DQ2_RK1_RX_ARDQ1_R_DLY_B1)
                    | P_Fld(0x5, SHU_R1_B1_DQ2_RK1_RX_ARDQ0_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ3, P_Fld(0x5, SHU_R1_B1_DQ3_RK1_RX_ARDQ3_R_DLY_B1)
                    | P_Fld(0x5, SHU_R1_B1_DQ3_RK1_RX_ARDQ2_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ4, P_Fld(0x5, SHU_R1_B1_DQ4_RK1_RX_ARDQ5_R_DLY_B1)
                    | P_Fld(0x5, SHU_R1_B1_DQ4_RK1_RX_ARDQ4_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ5, P_Fld(0x5, SHU_R1_B1_DQ5_RK1_RX_ARDQ7_R_DLY_B1)
                    | P_Fld(0x5, SHU_R1_B1_DQ5_RK1_RX_ARDQ6_R_DLY_B1));
        vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ6, P_Fld(0x16, SHU_R1_B1_DQ6_RK1_RX_ARDQS0_R_DLY_B1)
                    | P_Fld(0x5, SHU_R1_B1_DQ6_RK1_RX_ARDQM0_R_DLY_B1));    
    }
}
...
{
    //RK0_B0
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ2, P_Fld(0xf, SHU_R0_B0_DQ2_RK0_RX_ARDQ1_R_DLY_B0)
                | P_Fld(0xf, SHU_R0_B0_DQ2_RK0_RX_ARDQ0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ3, P_Fld(0xf, SHU_R0_B0_DQ3_RK0_RX_ARDQ3_R_DLY_B0)
                | P_Fld(0xf, SHU_R0_B0_DQ3_RK0_RX_ARDQ2_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ4, P_Fld(0xf, SHU_R0_B0_DQ4_RK0_RX_ARDQ5_R_DLY_B0)
                | P_Fld(0xf, SHU_R0_B0_DQ4_RK0_RX_ARDQ4_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ5, P_Fld(0xf, SHU_R0_B0_DQ5_RK0_RX_ARDQ7_R_DLY_B0)
                | P_Fld(0xf, SHU_R0_B0_DQ5_RK0_RX_ARDQ6_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B0_DQ6, P_Fld(0x0, SHU_R0_B0_DQ6_RK0_RX_ARDQS0_R_DLY_B0)
                | P_Fld(0xf, SHU_R0_B0_DQ6_RK0_RX_ARDQM0_R_DLY_B0));
    //RK1_B0
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ2, P_Fld(0xf, SHU_R1_B0_DQ2_RK1_RX_ARDQ1_R_DLY_B0)
                | P_Fld(0xf, SHU_R1_B0_DQ2_RK1_RX_ARDQ0_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ3, P_Fld(0xf, SHU_R1_B0_DQ3_RK1_RX_ARDQ3_R_DLY_B0)
                | P_Fld(0xf, SHU_R1_B0_DQ3_RK1_RX_ARDQ2_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ4, P_Fld(0xf, SHU_R1_B0_DQ4_RK1_RX_ARDQ5_R_DLY_B0)
                | P_Fld(0xf, SHU_R1_B0_DQ4_RK1_RX_ARDQ4_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ5, P_Fld(0xf, SHU_R1_B0_DQ5_RK1_RX_ARDQ7_R_DLY_B0)
                | P_Fld(0xf, SHU_R1_B0_DQ5_RK1_RX_ARDQ6_R_DLY_B0));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ6, P_Fld(0x0, SHU_R1_B0_DQ6_RK1_RX_ARDQS0_R_DLY_B0)
                | P_Fld(0xf, SHU_R1_B0_DQ6_RK1_RX_ARDQM0_R_DLY_B0));
    //RK0_B1
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ2, P_Fld(0xf, SHU_R0_B1_DQ2_RK0_RX_ARDQ1_R_DLY_B1)
                | P_Fld(0xf, SHU_R0_B1_DQ2_RK0_RX_ARDQ0_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ3, P_Fld(0xf, SHU_R0_B1_DQ3_RK0_RX_ARDQ3_R_DLY_B1)
                | P_Fld(0xf, SHU_R0_B1_DQ3_RK0_RX_ARDQ2_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ4, P_Fld(0xf, SHU_R0_B1_DQ4_RK0_RX_ARDQ5_R_DLY_B1)
                | P_Fld(0xf, SHU_R0_B1_DQ4_RK0_RX_ARDQ4_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ5, P_Fld(0xf, SHU_R0_B1_DQ5_RK0_RX_ARDQ7_R_DLY_B1)
                | P_Fld(0xf, SHU_R0_B1_DQ5_RK0_RX_ARDQ6_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R0_B1_DQ6, P_Fld(0x0, SHU_R0_B1_DQ6_RK0_RX_ARDQS0_R_DLY_B1)
                | P_Fld(0xf, SHU_R0_B1_DQ6_RK0_RX_ARDQM0_R_DLY_B1));
    //RK1_B1
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ2, P_Fld(0xf, SHU_R1_B1_DQ2_RK1_RX_ARDQ1_R_DLY_B1)
                | P_Fld(0xf, SHU_R1_B1_DQ2_RK1_RX_ARDQ0_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ3, P_Fld(0xf, SHU_R1_B1_DQ3_RK1_RX_ARDQ3_R_DLY_B1)
                | P_Fld(0xf, SHU_R1_B1_DQ3_RK1_RX_ARDQ2_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ4, P_Fld(0xf, SHU_R1_B1_DQ4_RK1_RX_ARDQ5_R_DLY_B1)
                | P_Fld(0xf, SHU_R1_B1_DQ4_RK1_RX_ARDQ4_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ5, P_Fld(0xf, SHU_R1_B1_DQ5_RK1_RX_ARDQ7_R_DLY_B1)
                | P_Fld(0xf, SHU_R1_B1_DQ5_RK1_RX_ARDQ6_R_DLY_B1));
    vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ6, P_Fld(0x0, SHU_R1_B1_DQ6_RK1_RX_ARDQS0_R_DLY_B1)
                | P_Fld(0xf, SHU_R1_B1_DQ6_RK1_RX_ARDQM0_R_DLY_B1));
}
...
static void DramcSetting_LP4_TX_Delay_DDR1600(DRAMC_CTX_T *p, DRAM_RANK_T eRank)
{
    ...
    else
    {
        ...
        {
            // for DDR1600 1:4 mode
            vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ7, P_Fld(0x1b, SHU_R1_B0_DQ7_RK1_ARPI_DQM_B0)
                        | P_Fld(0x1b, SHU_R1_B0_DQ7_RK1_ARPI_DQ_B0));
            vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ7, P_Fld(0x1b, SHU_R1_B1_DQ7_RK1_ARPI_DQM_B1)
                        | P_Fld(0x1b, SHU_R1_B1_DQ7_RK1_ARPI_DQ_B1));
        }
        else
        {
            if (vGet_Dram_CBT_Mode(p) == CBT_BYTE_MODE1)
            {
                ...
                vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ7, P_Fld(0x13, SHU_R1_B0_DQ7_RK1_ARPI_DQM_B0)
                            | P_Fld(0x13, SHU_R1_B0_DQ7_RK1_ARPI_DQ_B0));
                vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ7, P_Fld(0x12, SHU_R1_B1_DQ7_RK1_ARPI_DQM_B1)
                            | P_Fld(0x12, SHU_R1_B1_DQ7_RK1_ARPI_DQ_B1));
            }
            else
            {
                // for DDR1600 1:8 mode
                vIO32WriteFldMulti(DDRPHY_SHU_R1_B0_DQ7, P_Fld(0x26, SHU_R1_B0_DQ7_RK1_ARPI_DQM_B0)
                            | P_Fld(0x26, SHU_R1_B0_DQ7_RK1_ARPI_DQ_B0));
                vIO32WriteFldMulti(DDRPHY_SHU_R1_B1_DQ7, P_Fld(0x26, SHU_R1_B1_DQ7_RK1_ARPI_DQM_B1)
...
//francis remove                            | P_Fld(0x1, SHU_PLL7_RG_RCLRPLL_SDM_PCW_CHG));
    ...
    #if FSP1_CLKCA_TERM
    U8 u1CASwImpFreqRegion = (p->dram_fsp==FSP_0) ? LOW_FREQ : HIGH_FREQ;
    #else
    U8 u1CASwImpFreqRegion = (p->frequency <= 1866) ? LOW_FREQ : HIGH_FREQ;
    #endif
    U8 u1DQSwImpFreqRegion = (p->frequency <= 1866) ? LOW_FREQ : HIGH_FREQ;
...
void DramcShuTrackingEnBySRAM(DRAMC_CTX_T *p)
{
    U8 u1ShuffleIdx;
    ...
    for(u1ShuffleIdx = 0; u1ShuffleIdx<=DRAM_DFS_SRAM_MAX; u1ShuffleIdx++) //fill SHU1 of conf while (u1ShuffleIdx==DRAM_DFS_SRAM_MAX)
    {
        ...
        #if ENABLE_TX_TRACKING		 
            Enable_TX_Tracking(p,u4DramcShuOffset,u1ShuffleIdx);
        #endif
        #if RDSEL_TRACKING_EN
            Enable_RDSEL_Tracking(p,u4DramcShuOffset,u1ShuffleIdx);
        #endif
    }
}
...
#else
    mcSHOW_DBG_MSG(("HW_GATING DBG: ON (for spm dbg)\n"));
    DramcHWGatingDebugOnOff(p, ENABLE);
#endif
