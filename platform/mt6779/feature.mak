...
ifdef CFG_INFRA_RSVD3
C_OPTION += -DCFG_INFRA_RSVD3="$(CFG_INFRA_RSVD3)"
export CFG_INFRA_RSVD3
endif
...
ifeq ($(strip "$(MTK_LP4_DDR3200)"),"yes")
    C_OPTION += -DMTK_LP4_DDR3200
endif
...
ifeq ($(strip "$(MTK_INFRA_REG_SET_CLR)"),"yes")
    C_OPTION += -DMTK_INFRA_REG_SET_CLR
endif
...
ifdef CFG_FUNCTION_EEM_SUPPORT
C_OPTION += -DCFG_FUNCTION_EEM_SUPPORT="$(CFG_FUNCTION_EEM_SUPPORT)"
export CFG_FUNCTION_EEM_SUPPORT
endif
...
ifdef CFG_LOAD_SLT_PICACHU
C_OPTION += -DCFG_LOAD_SLT_PICACHU="$(CFG_LOAD_SLT_PICACHU)"
export CFG_LOAD_SLT_PICACHU
endif
...
ifeq ($(strip "$(MTK_VCORE_CT_SUPPORT)"),"yes")
    C_OPTION += -DMTK_VCORE_CT_SUPPORT
endif

ifeq ($(strip "$(MTK_VCORE_CPE_SUPPORT)"),"yes")
    C_OPTION += -DMTK_VCORE_CPE_ENABLE
endif
...
ifeq ($(strip "$(MTK_SRCLKEN_RC_SUPPORT)"),"yes")
    C_OPTION += -DMTK_SRCLKEN_RC_SUPPORT
endif

ifeq ($(strip "$(MT6360_PMU)"),"yes")
    C_OPTION += -DMT6360_PMU
endif

ifeq ($(strip "$(MT6360_PMIC)"),"yes")
    C_OPTION += -DMT6360_PMIC
endif

ifeq ($(strip "$(MT6360_LDO)"),"yes")
    C_OPTION += -DMT6360_LDO
endif
