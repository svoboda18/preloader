...
int i2c_hw_init(void)
{
	...
	mt_reg_sync_writel(0, I2C2_BASE_SE + OFFSET_ROLLBACK);
	mt_reg_sync_writel(0, I2C4_BASE_SE + OFFSET_ROLLBACK);
...
#if DIS_CH0_PULL
        I2C_SET_REG32(IOCFG_RB_BASE + 0xF0, (0x3 << 9) | (0x3 << 19),
		      (0 << 9) | (0 << 19));
        I2C_SET_REG32(IOCFG_RB_BASE + 0x60, (0x3 << 21), (0 << 21));
#endif

#if DIS_CH1_PULL
        I2C_SET_REG32(IOCFG_RB_BASE + 0xF0, (0x3 << 12) | (0x3 << 22),
		      (0 << 12) | (0 << 22));
...
#if DIS_CH2_PULL
        I2C_SET_REG32(IOCFG_RM_BASE + 0xF0, (0x3 << 14) | (0x3 << 24),
		      (0 << 14) | (0 << 24));
        I2C_SET_REG32(IOCFG_RM_BASE + 0x60, (0x3 << 28), (0 << 28));
#endif

#if DIS_CH3_PULL
        I2C_SET_REG32(IOCFG_BL_BASE + 0xF0, (0x3 << 7) | (0x3 << 12),
		      (0 << 7) | (0 << 12));
        I2C_SET_REG32(IOCFG_BL_BASE + 0x60, (0x3 << 0), (0 << 0));
#endif

#if DIS_CH4_PULL
        I2C_SET_REG32(IOCFG_RM_BASE + 0xF0, (0x3 << 17) | (0x3 << 27),
		      (0 << 17) | (0 << 27));
        I2C_SET_REG32(IOCFG_RM_BASE+ 0x60, (0x3 << 30), (0 << 30));
#endif

#if DIS_CH5_PULL
        I2C_SET_REG32(IOCFG_LB_BASE + 0xF0, (0x3 << 15) | (0x3 << 20),
		      (0 << 15) | (0 << 20));
        I2C_SET_REG32(IOCFG_LB_BASE + 0x60, (0x3 << 13), (0 << 13));
#endif

#if DIS_CH6_PULL
	/* PAD_EINT11 & EINT12 internal pullup disable */
        I2C_SET_REG32(IOCFG_LT_BASE + 0x60, (0x1 << 10) | (0x1 << 17),
		      (0 << 10) | (0 << 17));
#endif
