...
typedef struct _AC_TIMING_EXTERNAL_T
{
    ...
    U32 AC_TIME_EMI_TMRR2W_ODT_OFF_05T  :2; // Useless, no 0.5T in O_lympus and El_brus
    U32 AC_TIME_EMI_TMRR2W_ODT_ON_05T   :2; // Useless, no 0.5T in O_lympus and El_brus
...
#define HQA_VDRAM_LV_LP4		1087500
