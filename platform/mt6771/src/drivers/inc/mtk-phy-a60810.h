...
int phy_eyescan_a60810(struct u3phy_info *info, int x_t1, int y_t1, int x_br, int y_br, int delta_x, int delta_y
		, int eye_cnt, int num_cnt, int PI_cal_en, int num_ignore_cnt);
int u2_connect_a60810(struct u3phy_info *info);
int u2_disconnect_a60810(struct u3phy_info *info);
