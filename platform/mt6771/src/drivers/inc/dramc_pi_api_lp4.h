...
//#define SOLUTION_FOR_SS_B422_TX_WIN_TOO_SMALL 1   //Only for Bi_anco, Only for Samsung normal mode (B422), Only for DRVP >=15 ==> Set DRAM ODT to RZQ/3 (80ohm)
...
#define SYLVIA_DVFS_SSC_WORKAROUND 1
#if ENABLE_TX_WDQS
...
#define BYPASS_WRITELEVELING	0//(SUPPORT_SAVE_TIME_FOR_CALIBRATION & EMMC_READY)
...
#define ENABLE_RODT_TRACKING_SAVE_MCK 0 //Maybe turn on behind Vin_son project
...
#define CBT_MOVE_CA_INSTEAD_OF_CLK 0
...
#endif
#define ENABLE_MPLL_SSC 1 // only for E_verest ETT
#else // not ETT
