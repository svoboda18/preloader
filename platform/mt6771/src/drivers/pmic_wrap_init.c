...
static void _pwrap_enable(void)
{
	...
	WRAP_WR32(PMIC_WRAP_HPRIO_ARB_EN, 0x3fa77);
#endif
	...
	WRAP_WR32(PMIC_WRAP_INT1_EN, 0x80001ff); /* disable Matching interrupt for bit 28 */
}
...
static void _pwrap_config_mpu(void)
{
	 ...
	 * D0 (AP) D1(MD1) D5(N/A) D6(GZ)
	 */
	WRAP_WR32(PMIC_WRAP_MPU_CON1, 0xd); // pdomain_p2p[2:0] = 0x5 for p2p
	WRAP_WR32(PMIC_WRAP_MPU_PMIC_REG_PER_0, 0x0606cff3);
	/* WRAP_WR32(PMIC_WRAP_MPU_PWRAP_REG_PER_0, 0xcff30000); */
	PWRAPLOG("PMIC_WRAP_MPU_CON1 = 0x%x\n", WRAP_RD32(PMIC_WRAP_MPU_CON1));
	PWRAPLOG("PMIC_WRAP_MPU_PMIC_REG_PER_0 = 0x%x\n", WRAP_RD32(PMIC_WRAP_MPU_PMIC_REG_PER_0));
}

signed int pwrap_enable_mpu(bool en)
{
	WRAP_WR32(PMIC_WRAP_MPU_PMIC_REG_PER_4, 0x8000000);
	WRAP_WR32(PMIC_WRAP_MPU_CON0, 0x1);
	PWRAPLOG("PMIC_WRAP_MPU_PMIC_REG_PER_4 = 0x%x\n", WRAP_RD32(PMIC_WRAP_MPU_PMIC_REG_PER_4));
