...
#define SRAMROM_SEC_CTRL2       (INFRACFG_AO_BASE + 0x814)
#define SRAMROM_SEC_CTRL5       (INFRACFG_AO_BASE + 0x858)
#define SRAMROM_SEC_CTRL6       (INFRACFG_AO_BASE + 0x85C)

#define SRAMROM_SEC_ADDR        (INFRACFG_AO_BASE + 0x808)
#define SRAMROM_SEC_ADDR1       (INFRACFG_AO_BASE + 0x850)
#define SRAMROM_SEC_ADDR2       (INFRACFG_AO_BASE + 0x854)
