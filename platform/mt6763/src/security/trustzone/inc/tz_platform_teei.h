...
#define MT_UART0_DAPC (87)
#define MT_UART1_DAPC (88)
#define MT_UART2_DAPC (89)
#define MT_UART3_DAPC (90)

/* Secure Timer setting (SEJ) */
#define MT_SEC_GPT_BASE 0x1000A000
#define MT_SEC_GPT_IRQ (185+32)
#define MT_SEC_GPT_DAPC (10)

/* Secure watch Dog setting (SEJ) */
#define MT_SEC_WDT_BASE 0x1000A000
#define MT_SEC_WDT_IRQ (186+32)
#define MT_SEC_WDT_DAPC (10)

#define TEE_FCH_IRQ_NO  307
#define TEE_DRV_IRQ_NO  308
#define TEE_REV_IRQ_NO  306
#define TEE_DUMPER_IRQ_NO  309
