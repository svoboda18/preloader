...
#define SRAMROM_SEC_CTRL        (SECURITY_AO_BASE + 0x0010)
#define SRAMROM_SEC_CTRL2       (SECURITY_AO_BASE + 0x0018)
#define SRAMROM_SEC_CTRL5       (SECURITY_AO_BASE + 0x0024)
#define SRAMROM_SEC_CTRL6       (SECURITY_AO_BASE + 0x0028)

#define SRAMROM_SEC_ADDR        (SECURITY_AO_BASE + 0x0050)
#define SRAMROM_SEC_ADDR1       (SECURITY_AO_BASE + 0x0054)
#define SRAMROM_SEC_ADDR2       (SECURITY_AO_BASE + 0x0058)
