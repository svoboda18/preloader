...
extern U8 ucg_num_dlycell_perT_all[DRAM_DFS_SHUFFLE_MAX][CHANNEL_MAX];
extern U16 u2gdelay_cell_ps_all[DRAM_DFS_SHUFFLE_MAX][CHANNEL_MAX];
...
#if 0
    //!O_lympus : LP3 preloader  don't set this bit, *((volatile unsigned int*)(DDRPHY0AO_BASE  + (0x02b << 2) )) |= (0x1 << 16);   //RG_*VREF_EN=1
    *((volatile unsigned int*)(DDRPHY0AO_BASE  + (0x04b << 2) )) |= (0x1 << 16);   //RG_*VREF_EN=1
    //! O_lympus LP3,LP4 preloader don't assert this bit, *((volatile unsigned int*)(DDRPHY0AO_BASE  + (0x06b << 2) )) |= (0x1 << 16);   //RG_*VREF_EN=1
    if((u4DramType == 2) || (u4DramType == 3)) 
    {
        //! O_lympus : LP4 preloader  set this bit,
        ...
        *((volatile unsigned int*)(DDRPHY1AO_BASE  + (0x04b << 2) )) |= (0x1 << 16);   //RG_*VREF_EN=1
        //! O_lympus LP3,LP4 preloader don't assert this bit, *((volatile unsigned int*)(DDRPHY1AO_BASE  + (0x06b << 2) )) |= (0x1 << 16);   //RG_*VREF_EN=1
    }
#endif
...
VCORE_DELAYCELL_T gVcoreDelayCellTable[6]={ {84, 665},
                                            {80, 702},
                                            {76, 736},
                                            {74, 758},
                                            {70, 794},
...
#if defined(DRAM_HQA) || defined(__ETT__)
    get_vcore = mtk_regulator_get_voltage(&reg_vcore)/10000;
#endif        
