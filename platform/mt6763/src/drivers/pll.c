...
void mt_pll_init(void)
{
    ...
    DRV_WriteReg32(AP_PLL_CON2, temp | 0x1FFE0000);
#endif
    //step 1
    ...
    //step 45
    //DRV_WriteReg32(CCIPLL_CON1, 0x811713B1); // 600MHz, arm div = 2
    DRV_WriteReg32(CCIPLL_CON1, 0x81152762); // 550MHz, arm div = 2
...
//8: div1, A: div2, B: div4, 1D: div6
    ...
    DRV_WriteReg32(CLK_CFG_1, 0x01000100);
    DRV_WriteReg32(CLK_CFG_2, 0x00010101);
    DRV_WriteReg32(CLK_CFG_3, 0x04010100);
    DRV_WriteReg32(CLK_CFG_4, 0x01010004);
    ...
    DRV_WriteReg32(CLK_CFG_10, 0x01040303);//aud eng1/2: apll div 8
    #else
    DRV_WriteReg32(CLK_CFG_0, 0x01000002);
    ...
    print("mtcmos Done!\n");
    /*for CG*/
    DRV_WriteReg32(INFRA_PDN_CLR0, 0x9BEFFF7F);//7, 20, 26, 29, 30
    DRV_WriteReg32(INFRA_PDN_CLR1, 0x9F9F7FF6);//0, 3, 15, 21, 22, 29, 30
    DRV_WriteReg32(INFRA_PDN_SET1, 0x08000000);//27: dxcc
    DRV_WriteReg32(INFRA_PDN_CLR2, 0x7FFFFFDD);//1, 5, 31
    DRV_WriteReg32(INFRA_PDN_CLR3, 0x000001FF);//

    /*DISP CG Clear and DCM disable*/
    //DRV_WriteReg32(DISP_CG_CLR0, 0xFFFFFFFF);
    //DRV_WriteReg32(DISP_CG_CLR1, 0x000003FF);
