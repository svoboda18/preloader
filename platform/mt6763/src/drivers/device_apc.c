...
void device_APC_dom_setup(void)
{
    ...
    print("APC_CON: INFRA(0x%x), MD(0x%x), MM(0x%x)\n",
...
#if 1
    reg_write32(DEVAPC_AO_INFRA_MAS_DOM_0, 0x0);
    reg_write32(DEVAPC_AO_INFRA_MAS_DOM_1, 0x900);
    reg_write32(DEVAPC_AO_INFRA_MAS_DOM_2, 0x2000001);
    reg_write32(DEVAPC_AO_INFRA_MAS_DOM_3, 0x8060);
#else
...
#if 1
    reg_write32(DEVAPC_AO_INFRA_DOM_RMP_0, 0xEA3CF8C8);
#else
...
#if 1
    reg_write32(DEVAPC_AO_MD_DOM_RMP_0, 0xFDEC);
#else
...
// MM DOMAIN REMAP settings
...
#if 1
    reg_write32(DEVAPC_AO_MM_DOM_RMP_0, 0xFFFEFFFC);
#else
    //Remap domain 0~16 (4-bit domain) to domain 3 (2-bit domain) by default
    ...
    /* ---------------------------------------------------------------------------------------- */
    MSG(DOM, "DM 0x%x,0x%x,0x%x,0x%x, I 0x%x,0x%x, D 0x%x, M 0x%x\n",
        reg_read32(DEVAPC_AO_INFRA_MAS_DOM_0), reg_read32(DEVAPC_AO_INFRA_MAS_DOM_1),
        reg_read32(DEVAPC_AO_INFRA_MAS_DOM_2), reg_read32(DEVAPC_AO_INFRA_MAS_DOM_3),
        reg_read32(DEVAPC_AO_INFRA_DOM_RMP_0), reg_read32(DEVAPC_AO_INFRA_DOM_RMP_1),
        reg_read32(DEVAPC_AO_MD_DOM_RMP_0),
