...
typedef struct _AC_TIMING_EXTERNAL_T
{
    ...
    // U 05 
    U32 AC_TIME_EMI_TRTPD            :8; // LP4/LP3, // O_lympus new 
    U32 AC_TIME_EMI_TWTPD            :8; // LP4/LP3, // O_lympus new 
    U32 AC_TIME_EMI_TMRR2W_ODT_OFF   :8; // LP4      // O_lympus new 
    U32 AC_TIME_EMI_TMRR2W_ODT_ON    :8; // LP4      // O_lympus new 
    ...
    U32 AC_TIME_EMI_TWTR_05T          :2; // O_lympus modified
    U32 AC_TIME_EMI_TRRD_05T          :2;
    // Byte3	
    U32 AC_TIME_EMI_TFAW_05T          :2;
    U32 AC_TIME_EMI_TRTW_ODT_OFF_05T  :2;
    U32 AC_TIME_EMI_TRTW_ODT_ON_05T   :2;
    U32 AC_TIME_EMI_TRTPD_05T         :2; // LP4/LP3 // O_lympus new 

    // U 07
    // Byte0
    U32 AC_TIME_EMI_TWTPD_05T           :2; // LP4/LP3 // O_lympus new
    U32 AC_TIME_EMI_TMRR2W_ODT_OFF_05T  :2; // Useless, no 0.5T in O_lympus and E_lbrus
    U32 AC_TIME_EMI_TMRR2W_ODT_ON_05T   :2; // Useless, no 0.5T in O_lympus and E_lbrus
...
#if defined(SLT)
#define DRAM_HQA
//#define SLT_VCORE_LP4 688750
#else
#if __ETT__
#define DRAM_HQA
#endif
//#define HQA_SS_VOLTAGE
#endif
...
#if defined(SLT)
#define HQA_VCORE_HV_LP4_KOPP0	880000
#else
#define HQA_VCORE_HV_LP4_KOPP0	843750
#endif
#define HQA_VCORE_HV_LP4_KOPP1	762500
#define HQA_VCORE_HV_LP4_KOPP2	762500
#define HQA_VCORE_HV_LP4_KOPP3	762500
#define HQA_VDD2_HV_LP4			1170000
#define HQA_VDDQ_HV_LP4			650000

#define HQA_VCORE_NV_LP4_KOPP0	800000
#define HQA_VCORE_NV_LP4_KOPP1	725000
#define HQA_VCORE_NV_LP4_KOPP2	725000
#define HQA_VCORE_NV_LP4_KOPP3	725000
#define HQA_VDD2_NV_LP4			1125000
#define HQA_VDDQ_NV_LP4			600000

#define HQA_VCORE_LV_LP4_KOPP0	756250
#define HQA_VCORE_LV_LP4_KOPP1	687500
#define HQA_VCORE_LV_LP4_KOPP2	687500
#define HQA_VCORE_LV_LP4_KOPP3	687500
#define HQA_VDD2_LV_LP4			1090000
#define HQA_VDDQ_LV_LP4			580000

#if defined(SLT)
#define HQA_VCORE_HV_LP3_KOPP0	880000
#else
#define HQA_VCORE_HV_LP3_KOPP0	840000
#endif
#define HQA_VCORE_HV_LP3_KOPP1	840000
#define HQA_VCORE_HV_LP3_KOPP2	740000
#define HQA_VCORE_HV_LP3_KOPP3	740000
...
#define HQA_VCORE_LV_LP3_KOPP0	760000
#define HQA_VCORE_LV_LP3_KOPP1	760000
#define HQA_VCORE_LV_LP3_KOPP2	664000
#define HQA_VCORE_LV_LP3_KOPP3	664000
#define HQA_VDRAM_LV_LP3		1160000

#ifdef HQA_SS_VOLTAGE

#undef HQA_VCORE_HV_LP4_KOPP0
#undef HQA_VCORE_HV_LP4_KOPP1
#undef HQA_VCORE_HV_LP4_KOPP2
#undef HQA_VCORE_HV_LP4_KOPP3
#define HQA_VCORE_HV_LP4_KOPP0 843750
#define HQA_VCORE_HV_LP4_KOPP1 762500
#define HQA_VCORE_HV_LP4_KOPP2 762500
#define HQA_VCORE_HV_LP4_KOPP3 762500

#undef HQA_VCORE_NV_LP4_KOPP1
#undef HQA_VCORE_NV_LP4_KOPP2
#undef HQA_VCORE_NV_LP4_KOPP3
#define HQA_VCORE_NV_LP4_KOPP1 725000
#define HQA_VCORE_NV_LP4_KOPP2 725000
#define HQA_VCORE_NV_LP4_KOPP3 725000

#undef HQA_VDD2_NV_LP4
#define HQA_VDD2_NV_LP4        1170000
#undef HQA_VDDQ_NV_LP4
#define HQA_VDDQ_NV_LP4        650000

#undef HQA_VCORE_LV_LP4_KOPP0
#undef HQA_VCORE_LV_LP4_KOPP1
#undef HQA_VCORE_LV_LP4_KOPP2
#undef HQA_VCORE_LV_LP4_KOPP3
#define HQA_VCORE_LV_LP4_KOPP0 762500
#define HQA_VCORE_LV_LP4_KOPP1 687500
#define HQA_VCORE_LV_LP4_KOPP2 687500
#define HQA_VCORE_LV_LP4_KOPP3 687500

#undef HQA_VDD2_LV_LP4
#define HQA_VDD2_LV_LP4        1100000
#undef HQA_VDDQ_LV_LP4
#define HQA_VDDQ_LV_LP4        600000

#undef HQA_VCORE_HV_LP3_KOPP0
#undef HQA_VCORE_HV_LP3_KOPP1
#undef HQA_VCORE_HV_LP3_KOPP2
#undef HQA_VCORE_HV_LP3_KOPP3
#define HQA_VCORE_HV_LP3_KOPP0 843750
#define HQA_VCORE_HV_LP3_KOPP1 843750
#define HQA_VCORE_HV_LP3_KOPP2 762500
#define HQA_VCORE_HV_LP3_KOPP3 762500

#undef HQA_VCORE_NV_LP3_KOPP2
#undef HQA_VCORE_NV_LP3_KOPP3
#define HQA_VCORE_NV_LP3_KOPP2 725000
#define HQA_VCORE_NV_LP3_KOPP3 725000

#undef HQA_VCORE_LV_LP3_KOPP0
#undef HQA_VCORE_LV_LP3_KOPP1
#undef HQA_VCORE_LV_LP3_KOPP2
#undef HQA_VCORE_LV_LP3_KOPP3
#define HQA_VCORE_LV_LP3_KOPP0 762500
#define HQA_VCORE_LV_LP3_KOPP1 762500
#define HQA_VCORE_LV_LP3_KOPP2 687500
#define HQA_VCORE_LV_LP3_KOPP3 687500
...
#define STD_VDRAM				_SEL_PREFIX(VDRAM, NV, LP3)
...
//#define LVCORE_HVDRAM
	...
	#define HQA_VDRAM				_SEL_PREFIX(VDRAM, HV, LP3)
	...
	#define HQA_VDRAM				_SEL_PREFIX(VDRAM, NV, LP3)
	...
	#define HQA_VDRAM				_SEL_PREFIX(VDRAM, LV, LP3)
