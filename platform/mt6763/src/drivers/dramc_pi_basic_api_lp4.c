...
U8 _MappingFreqArray[LP3_DDR800+1]=
{0,0,1,1,1,2,2};
...
/*
    ...
    */  
    ...
    //mcSHOW_ERR_MSG(("u1GetICVersion_Bi_anco 0x%x\n", u4reg_value));
...
void DDRPhyFreqSel(DRAMC_CTX_T *p, DRAM_PLL_FREQ_SEL_T sel)
{
    ...
    if ((p->dram_type == TYPE_LPDDR4) && (p->frequency == 1200))    
    {        
        p->dram_fsp = FSP_1;        
        p->odt_onoff = ODT_ON;    
    }
...
enum
{
    ...
    AC_TIMING_FREQUENCY,
    AC_TIMING_DBI_ONOFF,// O_lympus new
    AC_TIMING_BYTE_MODE,// O_lympus new
    ...
    AC_TIMING_TRRD,
    AC_TIMING_TFAW,
    AC_TIMING_TRTW_ODT_OFF,// O_lympus new (External)
    AC_TIMING_TRTW_ODT_ON,// O_lympus new (External)
    AC_TIMING_REFCNT, //(REFFRERUN = 0)
    AC_TIMING_REFCNT_FR_CLK, //(REFFRERUN = 1)
    AC_TIMING_TXREFCNT,
    AC_TIMING_TZQCS,
    // O_lympus new (External)
    ...
    AC_TIMING_DMCATRAIN_INTV,   // O_lympus new, LP4 internal
...
#if ENABLE_LP3_SW
    //======= LP3 =================================================================
    // LP3 ACTimingTable originated from "Bi_anco LP3 ACTiming excel file"
    // LP3-1866, 933MHz
    {
