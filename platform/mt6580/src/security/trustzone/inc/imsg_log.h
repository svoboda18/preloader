 ...
 * All rights reserved
 *
 * This file and software is confident and proprietary to MICROTRUST Inc.
...
#define IMSG_ENTER(fmt, ...)     IMSG_PRINT_DBG(ENTER, "%s " fmt, __func__)
#define IMSG_LEAVE(fmt, ...)     IMSG_PRINT_DBG(LEAVE, "%s " fmt, __func__)
