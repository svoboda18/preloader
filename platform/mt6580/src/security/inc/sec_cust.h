...
#define CUSTOM_SEC_CFG_SIZE     (sizeof(CUSTOM_SEC_CFG))
...
/* secro settings */
    unsigned int                secro_len;
    unsigned int                secro_ac_enable;
    unsigned int                secro_ac_offset;
    unsigned int                secro_ac_len;
