...
#define RTC_REG_XOSC32_ENB		(1U << RTC_REG_XOSC32_ENB_SHIFT)
...
#define RTC_EOSC32_OPT			  (3U << 8)	/* 0: embedded clock switch back to dcxo decided by (eosc32_ck_alive & powerkey_match)
							   1: embedded clock switch back to dcxo decided by (powerkey_match)
 							*/
#define RTC_EMBCK_SRC_SEL		(1U << 7)
#define RTC_EMBCK_SEL_EOSC 		(1U << 7)
#define RTC_EMBCK_SEL_MODE		(1U << 6)
#define RTC_EMBCK_SEL_K_EOSC	 	(1U << 6)
#define RTC_XOSC32_ENB_SHIFT	  5
#define RTC_XOSC32_ENB	  		(1U << RTC_XOSC32_ENB_SHIFT)	/* 0 (32k crystal exist)	1 (32k crystal doesn't exist)*/
#define RTC_XOSCCALI_MASK		0x001f		/*Default 4'b0111, 2nd step suggest to set to 4'b0000 EOSC_CALI = charging cap calibration*/



#define OSC32CON_ANALOG_SETTING	RTC_EOSC32_VCT_EN | RTC_EOSC32_CHOP_EN  & (~RTC_REG_XOSC32_ENB) & (~RTC_EMBCK_SEL_MODE) | RTC_EMBCK_SEL_OPTION | RTC_EMBCK_SRC_SEL
...
#define RTC_CALI_MASK			0x7F
#define RTC_CALI_MAX			63
#define RTC_CALI_MIN		 -64
