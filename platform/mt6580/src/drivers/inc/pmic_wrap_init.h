...
#define WRAP_WR32(addr,val)        mt_reg_sync_writel((unsigned int)(val), ((unsigned int)addr))

#define WRAP_SET_BIT(BS,REG)       mt_reg_sync_writel((__raw_readl((void *)REG) | (U32)(BS)), ((unsigned int)REG))
#define WRAP_CLR_BIT(BS,REG)       mt_reg_sync_writel((__raw_readl((void *)REG) & (~(U32)(BS))), ((unsigned int)REG))
