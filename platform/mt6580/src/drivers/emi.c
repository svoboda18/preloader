...
#define NUM_EMI_RECORD_HARD_CODE (5)
...
unsigned int DRAM_MRR(int MRR_num)
{
    ...
    {
        MRR_DQ_map[0] = 0x001C1A19;
        MRR_DQ_map[1] = 0x001D1F18;
        MRR_DQ_map[2] = 0x00001B1E;
    } 
    else if (TYPE_LPDDR3 == dram_type)
    {
        /*if((*((volatile unsigned int *)(0x10206174))& 0x00000800)!=0)
        {
       	...
       	{
            MRR_DQ_map[0] = 0x00191F18;
            MRR_DQ_map[1] = 0x001A1B1D;
            MRR_DQ_map[2] = 0x00001C1E;
        }
    }
    else if (0x0F02 == dram_type) // Discrete Tablet LPDDR2
    {
        MRR_DQ_map[0] = 0x001D1F18;
        MRR_DQ_map[1] = 0x001A1B19;
        MRR_DQ_map[2] = 0x00001E1C;
    }
    else if (0x0F03 == dram_type) // Discrete Tablet LPDDR3
    {
        MRR_DQ_map[0] = 0x001D1F18;
        MRR_DQ_map[1] = 0x001A1B19;
        MRR_DQ_map[2] = 0x00001E1C;
    ...
    *(volatile unsigned *)(0x10001030) |= (1 << 1);
    __asm__ __volatile__ ("dsb" : : : "memory");
    gpt_busy_wait_us(200);//Wait > 200us
    *(volatile unsigned *)(0x10001034) &= ~(1 << 1);
...
// Support CONH for 6Gb or 12Gb for Denali start
        for(i = 0; i < 2; i++) {
        ...
        *EMI_CONH = conh;
// Support CONH for 6Gb or 12Gb for Denali end
...
*/
    ...
    *((V_UINT32P)(DRAMC0_BASE + 0x00f0)) = 0x00000000;  // PINMUX2 = 0 for LPDDR2 (1 for LPDDR3). [31] Enable 4-bit MUX
...
*/
    ...
    *((V_UINT32P)(DRAMC0_BASE + 0x01e0)) = 0x1110017f;	//0107 hj update ; CA DDR setting (LP2 pinmux)
    *((V_UINT32P)(DDRPHY_BASE + 0x01e0)) = 0x1110017f;	//0107 hj update ; CA DDR setting (LP2 pinmux)    
...
//#endif
        ...
        *((V_UINT32P)(DRAMC0_BASE + 0x0210)) = 0x4000903;
        *((V_UINT32P)(DDRPHY_BASE + 0x0210)) = 0x4000903;
        *((V_UINT32P)(DRAMC0_BASE + 0x0214)) = 0x9090B09;
        *((V_UINT32P)(DDRPHY_BASE + 0x0214)) = 0x9090B09;
        *((V_UINT32P)(DRAMC0_BASE + 0x0218)) = 0x10301;
        *((V_UINT32P)(DDRPHY_BASE + 0x0218)) = 0x10301;
        *((V_UINT32P)(DRAMC0_BASE + 0x021c)) = 0x7050807;
        *((V_UINT32P)(DDRPHY_BASE + 0x021c)) = 0x7050807;
        *((V_UINT32P)(DRAMC0_BASE + 0x0220)) = 0x2000703;
        *((V_UINT32P)(DDRPHY_BASE + 0x0220)) = 0x2000703;
        *((V_UINT32P)(DRAMC0_BASE + 0x0224)) = 0x7040703;
        *((V_UINT32P)(DDRPHY_BASE + 0x0224)) = 0x7040703;
        *((V_UINT32P)(DRAMC0_BASE + 0x0228)) = 0x1000400;
        *((V_UINT32P)(DDRPHY_BASE + 0x0228)) = 0x1000400;
        *((V_UINT32P)(DRAMC0_BASE + 0x022c)) = 0x20302;
        *((V_UINT32P)(DDRPHY_BASE + 0x022c)) = 0x20302;

        *((V_UINT32P)(DRAMC0_BASE + 0x0018)) = 0x2429272C;
        *((V_UINT32P)(DDRPHY_BASE + 0x0018)) = 0x2429272C;
        *((V_UINT32P)(DRAMC0_BASE + 0x001c)) = 0x2429272C;
        *((V_UINT32P)(DDRPHY_BASE + 0x001c)) = 0x2429272C;

        *((V_UINT32P)(DRAMC0_BASE + 0x00cc)) = 0x000000cc;
        *((V_UINT32P)(DDRPHY_BASE + 0x00cc)) = 0x000000cc;
        
        *((V_UINT32P)(DRAMC0_BASE + 0x0648)) = 0x0ff00ff0;
        *((V_UINT32P)(DDRPHY_BASE + 0x0648)) = 0x0ff00ff0;
...
*/
    ...
    *((V_UINT32P)(DDRPHY_BASE + 0x0124)) = 0xaa080022;
        ...
        *((V_UINT32P)(DRAMC0_BASE + 0x00f0)) = 0x40000000; // [30] pinmux, 1:LPDDR3, 0: LPDDR2. [31] Enable 4-bit MUX
        *((V_UINT32P)(DDRPHY_BASE + 0x00f0)) = 0x40000000; // [30] pinmux, 1:LPDDR3, 0: LPDDR2. [31] Enable 4-bit MUX
    ...
    //#endif
        ...
        *((V_UINT32P)(DDRPHY_BASE + 0x0028)) = 0xf1200f01;
        ...
        //else
        //{
        *((V_UINT32P)(DRAMC0_BASE + 0x01e0)) = 0x0110017f;    //LPDDR2EN set to 0
        *((V_UINT32P)(DDRPHY_BASE + 0x01e0)) = 0x0110017f;    //LPDDR2EN set to 0
        //}
        ...
        *((V_UINT32P)(DDRPHY_BASE + 0x01e8)) = emi_setting->DRAMC_ACTIM1_VAL;    //LPDDR3EN set to 1
        ...
        // reg map N/A (Denali has no this option. Force 4-bit swap)
        *((V_UINT32P)(DRAMC0_BASE + 0x0158)) = 0xf0f0f0f0;      // Edward: 4 bit swap enable 0xf0f0f0f0, disable 0xff00ff00
        *((V_UINT32P)(DDRPHY_BASE + 0x0158)) = 0xf0f0f0f0;
...
*/    
      ...
      //#ifdef REAL_MEMPLL_MDL
        ...
        *((V_UINT32P)(DDRPHY_BASE + 0x0004)) = emi_setting->DRAMC_CONF1_VAL;
        ...
        // Darren
        //*((V_UINT32P)(DRAMC0_BASE + 0x0008)) = 0x0180ae50; // [23] NEW for Denali, FREBW_FREN, [17:8] NEW for Denali, FREBW_FR
        //*((V_UINT32P)(DDRPHY_BASE + 0x0008)) = 0x0180ae50; // [23] NEW for Denali, FREBW_FREN, [17:8] NEW for Denali, FREBW_FR
        *((V_UINT32P)(DRAMC0_BASE + 0x0008)) = emi_setting->DRAMC_CONF2_VAL;
        *((V_UINT32P)(DDRPHY_BASE + 0x0008)) = emi_setting->DRAMC_CONF2_VAL;
      #endif
        ...
        *((V_UINT32P)(DDRPHY_BASE + 0x01f8)) = emi_setting->DRAMC_ACTIM05T_VAL;
        ...
        //*((V_UINT32P)(DRAMC0_BASE + 0x0008)) = 0x1180ae50; // [23] NEW for Denali, FREBW_FREN, [17:8] NEW for Denali, FREBW_FR
        //*((V_UINT32P)(DDRPHY_BASE + 0x0008)) = 0x1180ae50; // [23] NEW for Denali, FREBW_FREN, [17:8] NEW for Denali, FREBW_FR
        *((V_UINT32P)(DRAMC0_BASE + 0x0008)) = emi_setting->DRAMC_CONF2_VAL | 0x10000000;
        *((V_UINT32P)(DDRPHY_BASE + 0x0008)) = emi_setting->DRAMC_CONF2_VAL | 0x10000000;
      #endif
...
// CG_EN set to 0 for bring up
// 0x640[3] NA for Denali (for DDR3)
//#ifdef fcENABLE_DDRPHY_DCM_FUNC
//  #ifdef DDRPHY_3PLL_MODE
//    #ifdef DDRPHY_2PLL
//          *((V_UINT32P)(DDRPHY_BASE + 0x0640)) |= (0xffe98000<<0);
...
//#endif
        ...
        *((V_UINT32P)(DRAMC0_BASE + 0x0110)) = 0x00113381;      //dsiable R_DMMRS2RK, this bit enable will impact MRR result // Edward : Modify [14:12] XRTR2W 1->2 [10:8] XRTR2R 1->3
        *((V_UINT32P)(DDRPHY_BASE + 0x0110)) = 0x00113381;      //dsiable R_DMMRS2RK, this bit enable will impact MRR result
...
#if 1
        // RX DQ, DQS input delay
        *((V_UINT32P)(DRAMC0_BASE + 0x0210)) = 0xA090C08;
        *((V_UINT32P)(DDRPHY_BASE + 0x0210)) = 0xA090C08;
        *((V_UINT32P)(DRAMC0_BASE + 0x0214)) = 0x3000300;
        *((V_UINT32P)(DDRPHY_BASE + 0x0214)) = 0x3000300;
        *((V_UINT32P)(DRAMC0_BASE + 0x0218)) = 0xA090807;
        *((V_UINT32P)(DDRPHY_BASE + 0x0218)) = 0xA090807;
        *((V_UINT32P)(DRAMC0_BASE + 0x021c)) = 0x4040602;
        *((V_UINT32P)(DDRPHY_BASE + 0x021c)) = 0x4040602;
        *((V_UINT32P)(DRAMC0_BASE + 0x0220)) = 0x6090909;
        *((V_UINT32P)(DDRPHY_BASE + 0x0220)) = 0x6090909;
        *((V_UINT32P)(DRAMC0_BASE + 0x0224)) = 0x2000100;
        *((V_UINT32P)(DDRPHY_BASE + 0x0224)) = 0x2000100;
        *((V_UINT32P)(DRAMC0_BASE + 0x0228)) = 0x7070705;
        *((V_UINT32P)(DDRPHY_BASE + 0x0228)) = 0x7070705;
        *((V_UINT32P)(DRAMC0_BASE + 0x022c)) = 0x1020203;
        *((V_UINT32P)(DDRPHY_BASE + 0x022c)) = 0x1020203;

        *((V_UINT32P)(DRAMC0_BASE + 0x0018)) = 0x242B252C;
        *((V_UINT32P)(DDRPHY_BASE + 0x0018)) = 0x242B252C;
        *((V_UINT32P)(DRAMC0_BASE + 0x001c)) = 0x242B252C;
        *((V_UINT32P)(DDRPHY_BASE + 0x001c)) = 0x242B252C;
...
#ifdef H9TP64A8JDMCPR_KGM
index = 0;
#endif

#ifdef KMQ8X000SA_B414
index = 1;
#endif
...
#ifdef H9TKNNN8JDAPLR_NGM
index = 3;
#endif

#ifdef H9CKNNN8GTMPLR_NTH
index = 4;
#endif

//platform_get_mcp_id (id, emmc_nand_id_len,&fw_id_len);
print("[Check] Hardcode mt_get_mdl_number 0x%x\n", index);
return index;
...
int DFS_ability_detection(void)
{
	...
	if((rank0_coarse <=20 && rank1_coarse <= 20) && ((*((volatile unsigned int *)(0x10206048)) & 0x00000200) == 0)) {
#else // Denali-1/2
...
void pmic_voltage_read(void)
{
    ...
    ret_val = pmic_read_interface(MT6350_VPROC_CON9, &OldVcore1, 0x7F, 0);
    ret_val = pmic_read_interface(MT6350_VM_CON1, &OldVmem, 0x3, 4);
    ret_val = pmic_read_interface(MT6350_VM_CON1, &OldVmem1, 0x0F, 8);

    printf("[Vcore] MT6350_VPROC_CON9=0x%x,\r\n[Vmem] MT6350_VM_CON1/1=0x%x 0x%x\r\n", OldVcore1, OldVmem, OldVmem1);
}
...
void pmic_Vcore_adjust(int nAdjust)
{
    ...
    switch (nAdjust) {
        case 0: // HV
        	pmic_config_interface(MT6350_VPROC_CON9, 0x6C, 0x7F, 0);	// 1.375V
        	break;
        case 1:	// NV 
        	pmic_config_interface(MT6350_VPROC_CON9, 0x48, 0x7F, 0);	// 1.15V
        	break;
        case 2:	// LV 
        	pmic_config_interface(MT6350_VPROC_CON9, 0x3F, 0x7F, 0);	// 1.09375V        	
        	break;
        case 3: // VCORE1++
        	pmic_read_interface(MT6350_VPROC_CON9, &vcore_idx, 0x7F, 0);
                vcore_idx++;
        	pmic_config_interface(MT6350_VPROC_CON9, vcore_idx, 0x7F, 0);
        	break;
        case 4: // VCORE1--
        	pmic_read_interface(MT6350_VPROC_CON9, &vcore_idx, 0x7F, 0);
                vcore_idx--;
...
void pmic_Vmem_adjust(int nAdjust)
{
    switch (nAdjust) {
        case 0:
        	pmic_config_interface(MT6350_VM_CON1, 0, 0x3, 4);	// 1.20V
        	break;
        case 1:
        	pmic_config_interface(MT6350_VM_CON1, 1, 0x3, 4);	// 1.35V
        	break;
        case 2:
        	pmic_config_interface(MT6350_VM_CON1, 2, 0x3, 4);	// 1.50V
        	break;
        default:
        	pmic_config_interface(MT6350_VM_CON1, 0, 0x3, 4);	// 1.20V
        	break;
...
void pmic_Vmem_Cal_adjust(int nAdjust)
{
    switch (nAdjust) {
        case 0: //HV
        	pmic_config_interface(MT6350_VM_CON1, 0x0B, 0xF, 8);	// +0.10V
        	break;
        case 1: //NV
        	pmic_config_interface(MT6350_VM_CON1, 0x0F, 0xF, 8);	// +0.02V
        	break;
        case 2: //LV
        	pmic_config_interface(MT6350_VM_CON1, 0x02, 0xF, 8);	// -0.04V
        	break;
        default:
        	pmic_config_interface(MT6350_VM_CON1, 0x00, 0xF, 8);	// +0.00VV
        	break;
    }
}
...
void dram_HQA_adjust_voltage(int nAdjust)
{
#ifdef HVcore  //HV (Vc=1.375V, Vm=1.3V
          pmic_Vcore_adjust(0); // 1.37V          
...
void mt_set_DCM_clock (void)
{
    ...
    #ifdef DDRPHY_3PLL_MODE
        #ifdef DDRPHY_2PLL
            *((V_UINT32P)(DDRPHY_BASE + 0x0640)) |= (0xfeb98200<<0);
        #else
            *((V_UINT32P)(DDRPHY_BASE + 0x0640)) |= (0xfeb98200<<0);      //enable DDRPHY dynamic clk gating, // disable C_PHY_M_CK dynamic gating
        #endif
    #else
        // [16] R_MEMPLL2_FB_M_CK_CG_EN -> no need for 1PLL mode (feedback clock)
        *((V_UINT32P)(DDRPHY_BASE + 0x0640)) |= (0xfeb88200<<0);      //enable DDRPHY dynamic clk gating, // disable C_PHY_M_CK dynamic gating
    #endif
...
// NA for D123
    ...
    print("DRAMC COMBO_MCP calibration takes %d CPU cycles\n\r", temp);
#endif
...
// Run time config
    ...
    *((V_UINT32P)(DRAMC0_BASE + 0x01dc)) |= 0x0a000000; // [25] DCMEN=1, [27] DISSTOP26M_CG_CTR L
    *((V_UINT32P)(DDRPHY_BASE + 0x01dc)) |= 0x0a000000; // [25] DCMEN=1, [27] DISSTOP26M_CG_CTR L
    ...
    *((V_UINT32P)(DDRPHY_BASE + 0x01ec)) |= 0x00010000;            
    ...
    print("DRAMC EXIT calibration takes %d CPU cycles\n\r", temp);
#endif
...
#ifndef RELEASE
    print("enable P drive (initial settings), 0x0644:%xh\n", DRAMC_READ_REG(0x0644));
#endif
...
#ifndef RELEASE
        print("2.1. DRVP 0x00c0[15:12]:%xh\n", tmp);
#endif
...
#ifndef RELEASE
    print("enable N drive (initial settings), 0x0644:%xh\n", DRAMC_READ_REG(0x0644));
#endif
