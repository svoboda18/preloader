...
#priority: PL mode > project config > flavor cust > base cust > default
include $(MTK_PATH_PLATFORM)/default.mak
include ${MTK_ROOT_CUSTOM}/${TARGET}/cust_bldr.mak
ifneq ("$(wildcard ${MTK_ROOT_CUSTOM}/${MTK_PROJECT}/cust_bldr.mak)", "")
include ${MTK_ROOT_CUSTOM}/${MTK_PROJECT}/cust_bldr.mak
endif
