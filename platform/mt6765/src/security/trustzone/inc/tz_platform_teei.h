...
#define MT_SEC_GPT_IRQ (221)
#define MT_SEC_GPT_DAPC (10)

/* Secure watch Dog setting (SEJ) */
#define MT_SEC_WDT_BASE (0x1000A000)
#define MT_SEC_WDT_IRQ (222)
#define MT_SEC_WDT_DAPC (10)

#define TEE_FCH_IRQ_NO  (284)
#define TEE_DRV_IRQ_NO  (285)
#define TEE_REV_IRQ_NO  (283)
#define TEE_DUMPER_IRQ_NO  (286)
