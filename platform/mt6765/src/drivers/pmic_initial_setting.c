...
struct pmic_setting init_setting[] = {
	...
	{0x18E6, 0x1, 0x1, 0},
	{0x19B4, 0xD, 0x7F, 0},
	{0x19B6, 0xF0F, 0x7F7F, 0},
	{0x19D2, 0x2D, 0x7F, 0},
	{0x19D4, 0x70F, 0x7F7F, 0},
	{0x1B9E, 0x1, 0x1, 0},
};
...
static void wk_vcore_lp_setting(void)
{
        pmic_config_interface(PMIC_RG_BUCK_VCORE_OSC_SEL_DIS_ADDR, 0x1,
			      PMIC_RG_BUCK_VCORE_OSC_SEL_DIS_MASK,
			      PMIC_RG_BUCK_VCORE_OSC_SEL_DIS_SHIFT);
	pmic_config_interface(PMIC_RG_BUCK_VMODEM_OSC_SEL_DIS_ADDR, 0x1,
			      PMIC_RG_BUCK_VMODEM_OSC_SEL_DIS_MASK,
			      PMIC_RG_BUCK_VMODEM_OSC_SEL_DIS_SHIFT);
	pmic_config_interface(PMIC_RG_PSEQ_RTCA_XCPT_MASK_ADDR, 0x0,
...
void pmic_init_setting(void)
{
	...
	pmic_config_interface(PMIC_RG_KEYPWR_VCORE_OPT_ADDR, 0x1,
			      PMIC_RG_KEYPWR_VCORE_OPT_MASK,
			      PMIC_RG_KEYPWR_VCORE_OPT_SHIFT);
	print("[PMIC] pmic_init_setting end. v180104\n");
