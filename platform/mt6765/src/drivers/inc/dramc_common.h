...
#define mcDELAY_US(x)       if (gDUMP_INIT_RG_LOG_TO_DE_RG_log_flag) mcSHOW_DBG_MSG4(("DELAY_US(%d);\n",x)); GPT_Delay_us((U32) (x))
...
/**********************************************/
  ...
  #define print
    ...
    #define mcSHOW_DBG_MSG4(_x_) 
    #define mcSHOW_DBG_MSG5(_x_)    
    #define mcSHOW_EYESCAN_MSG(_x_) {opt_print _x_;}   //mcSHOW_DBG_MSG5(_x_) is for vendor JV   
    ...
    #define mcSHOW_DBG_MSG2(_x_)    
    #define mcSHOW_DBG_MSG3(_x_)    
    #define mcSHOW_DBG_MSG4(_x_)  opt_print _x_; 
    #define mcSHOW_DBG_MSG5(_x_)
    #define mcSHOW_EYESCAN_MSG(_x_)    
    #define mcSHOW_TIME_MSG(_x_)      
    #define mcSHOW_ERR_MSG(_x_) 
