...
#define CONFIG_BASE         (IO_PHYS + 0x1000)		/* FIXME do not list in mt6765 memory map*/
#define INFRACFG_AO_BASE    (IO_PHYS + 0x1000)

/* GPIO base address */
#define GPIO_BASE           (IO_PHYS + 0x5000)
#define IOCFG_LT_BASE	(IO_PHYS + 0x2000)/* IOCFG_1_BASE */
#define IOCFG_LM_BASE	(IO_PHYS + 0x2200)/* IOCFG_2_BASE */
#define IOCFG_LB_BASE	(IO_PHYS + 0x2400)/* IOCFG_3_BASE */
#define IOCFG_BL_BASE	(IO_PHYS + 0x2600)/* IOCFG_4_BASE */
#define IOCFG_RR_BASE	(IO_PHYS + 0x2800)/* IOCFG_5_BASE */
#define IOCFG_RB_BASE	(IO_PHYS + 0x2A00)/* IOCFG_6_BASE */
#define IOCFG_RT_BASE	(IO_PHYS + 0x2C00)/* IOCFG_7_BASE */
...
//#define CA7MCUCFG_BASE      (IO_PHYS + 0x00200100)	/* FIXME do not list in mt6765 memory map*/
//#define CA15L_CONFIG_BASE   (IO_PHYS + 0x00200200)	/* FIXME do not list in mt6765 memory map*/
...
#define MIPI_TX0_BASE         (IO_PHYS + 0x00215000)    /* FIXME do not list in mt6765 memory map*/
#define MIPI_RX_ANA_CSI0_BASE (IO_PHYS + 0x00217000)    /* FIXME do not list in mt6765 memory map*/
#define MIPI_RX_ANA_CSI1_BASE (IO_PHYS + 0x00218000)    /* FIXME do not list in mt6765 memory map*/
...
#define UART3_BASE          (IO_PHYS + 0x01005000)      /* FIXME do not list in mt6765 memory map*/
...
//#define NFI_BASE            (IO_PHYS + 0x0100D000)    //Yi-Lung: Do not list it MT6765 memory map
//#define NFIECC_BASE         (IO_PHYS + 0x0100E000)    //Yi-Lung: Do not list it MT6765 memory map
#define USB_BASE            (IO_PHYS + 0x01200000)
#define DEVINFO_BASE        (IO_PHYS + 0x01C50000)
...
#define MSDC3_BASE          (IO_PHYS + 0x01260000)      //MingTsang: remove from the mt6765 memory map
//#define U3D_BASE          (IO_PHYS + 0x01270000)      /* FIXME do not list in mt6765 memory map*/
...
#define SSUSB_SIFSLV_SPLLC_BASE			(USB_SIF2_BASE + 0x000)	/* FIXME do not list in mt6765 memory map*/
#define SSUSB_SIFSLV_IPPC_BASE			(USB_SIF_BASE + 0x700)	/* FIXME do not list in mt6765 memory map*/
#define SSUSB_SIFSLV_U2PHY_COM_BASE		(USB_SIF2_BASE + 0x800)	/* FIXME do not list in mt6765 memory map*/
#define SSUSB_SIFSLV_U3PHYD_BASE		(USB_SIF2_BASE + 0x900)	/* FIXME do not list in mt6765 memory map*/
#define SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE	(USB_SIF2_BASE + 0x800)	/* FIXME do not list in mt6765 memory map*/
#define SSUSB_USB30_PHYA_SIV_B_BASE				(USB_SIF2_BASE + 0xB00) /* FIXME do not list in mt6765 memory map*/
#define SSUSB_SIFSLV_U3PHYA_DA_BASE				(USB_SIF2_BASE + 0xC00) /* FIXME do not list in mt6765 memory map*/
...
/* IRQ */
#define SYS_TIMER_IRQ       (194 + 32)

#endif //#ifndef MT6765_H
