...
#if 0/* delete by Xuexi, as this is defined in mt_reg_base.h of gpio_const.h */
...
typedef struct {
    ...
    VAL_REGS    dout[16];/* 0x0100 ~ 0x01FF: 256 bytes */
    VAL_REGS    din[16];/* 0x0200 ~ 0x02FF: 256 bytes */
    VAL_REGS    mode[23];/* 0x0300 ~ 0x0470: 368 bytes */
} GPIO_REGS;
