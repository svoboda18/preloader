...
#define fcCannon        10
#define fcCervino       11
#define fcFOR_CHIP_ID   fcCervino
#define fcFOR_PINMUX    fcCervino
...
// 2400 workaround for fcCervino only
...
#endif
#define DRIVING_WA_FOR_LP3_CA 1
#define IMPEDANCE_TRACKING_ENABLE //Impendence tracking
#define IMPEDANCE_HW_SAVING_OLD_MODE 0  //old mode: sw workaround mode
...
typedef struct _DRAM_INFO_BY_MRR_T
{
    ...
    U32 u4RankNum;
    U8 u1DieNum[CHANNEL_NUM][RANK_MAX];
} DRAM_INFO_BY_MRR_T;
