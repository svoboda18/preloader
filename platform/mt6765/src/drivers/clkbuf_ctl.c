...
#define clk_buf_pr_info(fmt, args...)		print(fmt, ##args)
...
static u8 drv_curr_vals[XO_NUMBER] = {CLK_BUF_DRIVING_CURR_1,
	CLK_BUF_DRIVING_CURR_1, CLK_BUF_DRIVING_CURR_1,
	CLK_BUF_DRIVING_CURR_1, CLK_BUF_DRIVING_CURR_1,
	CLK_BUF_DRIVING_CURR_1, CLK_BUF_DRIVING_CURR_1};
...
int clk_buf_init(void)
{
	...
	clk_buf_pr_info("%s: is skipped for bring-up\n", __func__);
