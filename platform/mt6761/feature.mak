...
ifeq ("$(MTK_LP4_HIGHEST_DDR2400)","yes")
	C_OPTION += -DMTK_LP4_HIGHEST_DDR2400
endif

ifeq ("$(MTK_LP3_HIGHEST_DDR1600)","yes")
	C_OPTION += -DMTK_LP3_HIGHEST_DDR1600
endif
...
ifeq ("$(MTK_DREQ_DIS)","yes")
	C_OPTION += -DMTK_DREQ_DIS
endif
...
ifeq ($(strip "$(MTK_VCORE_DVFS_SKIP_EFUSE)"),"yes")
    C_OPTION += -DMTK_VCORE_DVFS_SKIP_EFUSE
endif
...
ifeq ($(strip "$(MTK_MINI_SQC_SUPPORT)"),"yes")
    C_OPTION += -DMTK_MINI_SQC_SUPPORT
endif
...
C_OPTION += -DSWCHR_POWER_PATH="$(SWCHR_POWER_PATH)"
endif

ifeq ($(strip "$(MTK_ATF_LOG_BUF_SLIM)"),"yes")
    C_OPTION += -DMTK_ATF_LOG_BUF_SLIM
endif
