...
/* UART setting */
#define MT_UART0_IRQ (67)
#define MT_UART1_IRQ (68)
...
#define MT_SEC_GPT_IRQ (165)
#define MT_SEC_GPT_DAPC (10)

/* Secure watch Dog setting (SEJ) */
#define MT_SEC_WDT_BASE (0x1000A000)
#define MT_SEC_WDT_IRQ (166)
#define MT_SEC_WDT_DAPC (10)

#define TEE_FCH_IRQ_NO  (223)
#define TEE_DRV_IRQ_NO  (224)
#define TEE_REV_IRQ_NO  (222)
#define TEE_DUMPER_IRQ_NO  (225)
