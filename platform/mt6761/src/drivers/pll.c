...
47,
48,
49	AD_PLLGP2_TST_CK,   // original AD_CCIPLL_CK in cervino
50	AD_MPLL_208M_CK,
...
void mt_pll_init(void)
{
	...
	*********************/
	//step 26
	DRV_WriteReg32(ARMPLL_CON1, 0x81176276); // [25:0] (ARMPLL_N_INFO, 1216MHz)
	...
	//step 34
	DRV_WriteReg32(MMPLL_CON1, 0x8210C4EC); // [21:0] (MMPLL_N_INFO, 436MHz)
	...
	* xPLL HW Control
	...
	DRV_WriteReg32(PLLON_CON0, temp & 0xffffffbf); // [6]=0  use HW delay mode (by_maindiv_dly)
	...
	*/
	...
	/* config other clocks */
	/* scp_sel=top_ap_clk_ctrl_f26m_ck(0), mm_sel=univpll1_d2(6), ddrphycfg_ck=don't touch,  mem_sel=DMPLL_CK(1),axi=syspll1_d7(1) */
	...
	DRV_WriteReg32(MODULE_SW_CG_3_CLR, 0x003fffff);

	/* DISP CG */
	DRV_WriteReg32(MMSYS_CG_CLR0, 0x3FFFFFFF);
