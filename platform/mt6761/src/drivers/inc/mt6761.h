...
#define CONFIG_BASE         (IO_PHYS + 0x1000)		/* FIXME do not list in mt6761 memory map*/
...
//#define CA7MCUCFG_BASE      (IO_PHYS + 0x00200100)	/* FIXME do not list in mt6761 memory map*/
//#define CA15L_CONFIG_BASE   (IO_PHYS + 0x00200200)	/* FIXME do not list in mt6761 memory map*/
...
#define MIPI_TX0_BASE         (IO_PHYS + 0x00215000)    /* FIXME do not list in mt6761 memory map*/
#define MIPI_RX_ANA_CSI0_BASE (IO_PHYS + 0x00217000)    /* FIXME do not list in mt6761 memory map*/
#define MIPI_RX_ANA_CSI1_BASE (IO_PHYS + 0x00218000)    /* FIXME do not list in mt6761 memory map*/
#define GICD_BASE           (0x0C000000)
#define GICR_BASE           (0x0C080000)
...
#define UART3_BASE          (IO_PHYS + 0x01005000)      /* FIXME do not list in mt6761 memory map*/
...
//#define NFI_BASE            (IO_PHYS + 0x0100D000)    //Yi-Lung: Do not list it MT6761 memory map
//#define NFIECC_BASE         (IO_PHYS + 0x0100E000)    //Yi-Lung: Do not list it MT6761 memory map
...
#define MSDC3_BASE          (IO_PHYS + 0x01260000)      //MingTsang: remove from the mt6761 memory map
//#define U3D_BASE          (IO_PHYS + 0x01270000)      /* FIXME do not list in mt6761 memory map*/
