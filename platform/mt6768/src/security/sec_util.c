...
static uint8_t sec_img_buf[SEC_IMG_BUFFER_LENGTH];
static uint8_t sec_working_buf[SEC_WORKING_BUFFER_LENGTH];
static uint8_t sec_lib_heap_buf[SEC_LIB_HEAP_LENGTH];
