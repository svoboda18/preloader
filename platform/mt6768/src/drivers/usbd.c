        ...
        case USB_DESCRIPTOR_TYPE_CONFIGURATION:
            {
                ...
                config = device->configuration_array + configNum;
        ...
        switch (request->bRequest)
        {
            ...
            case STDREQ_CLEAR_FEATURE:
                ...
                case USB_RECIP_ENDPOINT:
                    {
                        u8 dir = request->wIndex & USB_DIR_MASK;;
                        u8 ep_num = request->wIndex & 0x0f;
                        print ("STDREQ_CLEAR_FEATURE,ep_num=%d, dir=%d\n", ep_num, dir);
                    ...
                    return 0;
                default:
                    print ("Unsupported command for STDREQ_CLEAR_FEATURE\n");
                    break;
                }
            default:
...
void mt_udc_reset (void)
{
    ...
    */
    ...
    {
        mt_udc_flush_fifo (i, USB_DIR_OUT);
        mt_udc_flush_fifo (i, USB_DIR_IN);
    }
    ...
    if ((endpoint->endpoint_address & USB_EP_DIR_MASK) == USB_DIR_OUT)
    {
        ...
        switch (max_packet_size)
        {
            ...
            case 64:
                ...
                break;
            case 128:
                fifo_size = FIFOSZ_128;
                break;
            case 256:
                fifo_size = FIFOSZ_256;
                break;
            case 512:
                fifo_size = FIFOSZ_512;
                break;
            case 1024:
                fifo_size = FIFOSZ_1024;
                break;
            case 2048:
                fifo_size = FIFOSZ_2048;
                break;
            case 4096:
                fifo_size = FIFOSZ_4096;
                break;
            case 3072:
                fifo_size = FIFOSZ_4096;
                break;
        ...
        /* Set double buffer fifo */
        __raw_writeb (fifo_size | DPB, RXFIFOSZ);
    }
    else
    {
        /* Clear data toggle to 0 */
        ...
        /* Set double buffer fifo */
        __raw_writeb (fifo_size | DPB, TXFIFOSZ);
    }

    /* Shift double buffer fifo size */
    fifo_addr += max_packet_size * 2;
