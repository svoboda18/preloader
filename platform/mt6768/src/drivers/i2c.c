	...
	U32 *timing_sample_cnt)
{
	...
	/* Just for MT6761/MT6762/MT6765/MT6768 */
...
int i2c_hw_init(void)
{
	...
	/* 0x2:15k 0x3:1k */
	/*I2C0,1*/
	I2C_SET_REG32(IOCFG_RB_BASE + 0x90, 0xFF, 0xFF);
	/*I2C2,4*/
	I2C_SET_REG32(IOCFG_RM_BASE + 0xf0, 0xFF, 0xFF);
	/*I2C6*/
	I2C_SET_REG32(IOCFG_LT_BASE + 0x90, 0xF, 0xF);
	/*I2C3,5,7*/
	I2C_SET_REG32(IOCFG_BL_BASE + 0x90, 0xFFF, 0xFFF);
	...
	/*I2C0,1*/
	I2C_SET_REG32((IOCFG_RB_BASE + 0x30), 0x0FFF, 0x0FFF);
	/*I2C2,4*/
	I2C_SET_REG32((IOCFG_RM_BASE + 0x40), 0x0FFF, 0x0FFF);
	/*I2C6*/
	I2C_SET_REG32((IOCFG_LT_BASE + 0x30), 0x3F, 0x3F);
	/*I2C3,5,7*/
	I2C_SET_REG32((IOCFG_BL_BASE + 0x30), 0x3FFFF, 0x3FFFF);
	...
	I2C_SET_REG32((I2C3_BASE_SE + OFFSET_MULTI_DMA), SHADOW_REG_MODE, (0x01<<1));
	...
	I2CLOG("[i2c3]ADDR:0x%x,multi_DMA:0x%x\n", I2C3_BASE_SE + OFFSET_MULTI_DMA,
		DRV_Reg32(I2C3_BASE_SE + OFFSET_MULTI_DMA));
