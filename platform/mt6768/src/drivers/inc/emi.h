...
typedef struct _AC_TIMING_EXTERNAL_T
{
	...
	/* U 05 */
	U32 AC_TIME_EMI_TRTPD            :8; /* LP4 / LP3, / / Olym_pus new */
	U32 AC_TIME_EMI_TWTPD            :8; /* LP4 / LP3, / / Olym_pus new */
	U32 AC_TIME_EMI_TMRR2W_ODT_OFF   :8; /* LP4 / / Olym_pus new */
	U32 AC_TIME_EMI_TMRR2W_ODT_ON    :8; /* LP4 / / Olym_pus new */
	...
	U32 AC_TIME_EMI_TWTR_05T          :2; /* Olym_pus modified */
	U32 AC_TIME_EMI_TRRD_05T          :2;
	/* Byte3 */
	U32 AC_TIME_EMI_TFAW_05T          :2;
	U32 AC_TIME_EMI_TRTW_ODT_OFF_05T  :2;
	U32 AC_TIME_EMI_TRTW_ODT_ON_05T   :2;
	U32 AC_TIME_EMI_TRTPD_05T         :2; /* LP4 / LP3 / / Olym_pus new */

	/*
	 * U 07
	 * Byte0
	 */
	U32 AC_TIME_EMI_TWTPD_05T           :2; /* LP4 / LP3 / / Olym_pus new */
	U32 AC_TIME_EMI_TMRR2W_ODT_OFF_05T  :2; /* Useless, no 0.5T in Olym_pus and El_brus */
	U32 AC_TIME_EMI_TMRR2W_ODT_ON_05T   :2; /* Useless, no 0.5T in Olym_pus and El_brus */
...
static inline EMI_SETTINGS *get_emi_setting(void)
{
	EMI_SETTINGS *emi_set = & default_emi_setting;
...
#define HQA_VCORE_HV_LP4_KOPP1	843750
...
#define HQA_VCORE_NV_LP4_KOPP1	800000
...
#define HQA_VCORE_LV_LP4_KOPP1	756250
...
#define HQA_VCORE_HV_LP3_KOPP4	687500
...
typedef struct _DRAM_SLT_DATA_T
{
	...
	u32 test_result[SLT_TESTDATA_ENTRY];
} DRAM_SLT_DATA_T;
