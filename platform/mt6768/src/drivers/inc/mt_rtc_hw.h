...
/* Secure RTC */
#define RTC_TC_SEC_SEC				(PMIC_TC_SECOND_SEC_ADDR)
#define RTC_TC_MIN_SEC				(PMIC_TC_MINUTE_SEC_ADDR)
#define RTC_TC_HOU_SEC				(PMIC_TC_HOUR_SEC_ADDR)
#define RTC_TC_DOM_SEC				(PMIC_TC_DOM_SEC_ADDR)
#define RTC_TC_DOW_SEC				(PMIC_TC_DOW_SEC_ADDR)
#define RTC_TC_MTH_SEC				(PMIC_TC_MONTH_SEC_ADDR)
#define RTC_TC_YEA_SEC				(PMIC_TC_YEAR_SEC_ADDR)

#define RTC_WRTGR_SEC				(PMIC_RTC_SEC_WRTGR_ADDR)
#define RTC_SEC_CK_PDN				(PMIC_RTC_SEC_CK_PDN_ADDR)

#define RTC_SEC_DSN_REV0			(MT6358_RTC_SEC_DSN_REV0)
#define RTC_SEC_DSN_ID				(MT6358_RTC_SEC_DSN_ID)

#define RTC_SEC_BASE					RTC_SEC_DSN_ID
