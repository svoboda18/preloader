...
#define CFG_TEE_CORE_SIZE               (0x500000 + CFG_TEE_TRUSTED_APP_HEAP_SIZE + CFG_TEE_TUI_HEAP_SIZE + CFG_TEE_FP_HEAP_SIZE)
#else
...
extern void platform_set_chrg_cur(int ma);
...
extern void plat_clean_invalidate_dcache(void);
extern bool plat_get_dcache_status(void);
extern void plat_set_dcache_status(bool bEnable);
#endif
