...
#define fcLafite         13
#define fcTalbot        14
#define fcFOR_CHIP_ID   fcTalbot
#define fcFOR_PINMUX    fcTalbot
...
/* #define SOLUTION_FOR_SS_B422_TX_WIN_TOO_SMALL 1   //Only for 6763, Only for Samsung normal mode (B422), Only for DRVP >=15 ==> Set DRAM ODT to RZQ/3 (80ohm) */
...
#define EYESCAN_LOG 1   /* draw eye diagram after calibration, if enable, need to fix code size problem (maybe disable ENABLE_LP3_SW first for temp workaround) */
...
#define ENABLE_DVS 0
#define DRAMC_DFS_MODE 1 /* 0:RG / SPM, 1:SPM, 2:RG: cc changed to dynamic mode for DVT */
...
#define PINMUX_AUTO_TEST_PER_BIT_CA 0 //LP3 LP4
#define PINMUX_AUTO_TEST_PER_BIT_RX 0 //LP4
#define PINMUX_AUTO_TEST_PER_BIT_RX_LP3 0 //LP3
...
#define BYPASS_RXPIPE_EN
//#define BYPASS_TXPIPE_EN

#define FSP1_CLKCA_TERM		1
#define ENABLE_SSC		0 /* For DVT to turn on SSC */
...
#define LP3_MR_INIT_AFTER_CA_TRAIN 1 // Do mode register init after CA training
#endif
 ...
 * #define SKH_POST_PACKAGE_REPAIR_LP3
 */
...
#undef ENABLE_TMRRI_NEW_MODE
#define ENABLE_TMRRI_NEW_MODE 0
#undef BYPASS_TXPIPE_EN //CMD fail(rxtx margin)
#endif
...
//cc mark after setting review #undef XRTR2R_PERFORM_ENHANCE_DQSG_RX_DLY
...
#endif
#define ENABLE_MPLL_SSC 1 /* only for Ever_est ETT */
#else /* not ETT */
...
#define LP4_3733_freq_meter  448
...
extern U16 gFinalRXPerbitWinSiz[CHANNEL_NUM][DQ_DATA_WIDTH];
#endif
...
#if ENABLE_EMI_LPBK_TEST || defined(SLT)
