...
void DVFSSettings(DRAMC_CTX_T *p)
{
    ...
    //@Maoauo, Cann_on IMP CDC options @Async mode
    vIO32WriteFldMulti_All(DDRPHY_MISC_CTRL0, P_Fld(1, MISC_CTRL0_IMPCAL_CDC_ECO_OPT) | P_Fld(u1ImpAsync, MISC_CTRL0_IDLE_DCM_CHB_CDC_ECO_OPT));    
...
#if DVT_TEST_DUMMY_RD_SIDEBAND_FROM_SPM || ENABLE_DFS_SSC_WA || ENABLE_DVS
