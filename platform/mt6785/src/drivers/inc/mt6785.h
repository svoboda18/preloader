...
#define SMI_COMMON_BASE     (IO_PHYS + 0x04019000)
...
#define CHN0_EMI_BASE       (IO_PHYS + 0x00235000)
#define CHN1_EMI_BASE       (IO_PHYS + 0x00245000)
...
#define MSDC0_TOP_BASE      (IO_PHYS + 0x11F50000)
#define MSDC1_TOP_BASE      (IO_PHYS + 0x11E10000)
...
#define U3D_BASE            (IO_PHYS + 0x01200000) /* MAC: 0x1180_0000 */
