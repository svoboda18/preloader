...
extern U8 ucDram_Register_Write(DRAMC_CTX_T *p, U32 u4reg_addr, U32 u4reg_mask, U32 u4reg_value);
#else
...
#if REG_ACCESS_PORTING_DGB
#define vIO32Write4B(reg32,val32) ucDram_Register_Write(p,reg32, 0xffffffff, val32)
#else
...
#define vIO32Write4BAPBMsk(reg32, val32, start32, len32) vIO32Write4BAPBMsk2(p, reg32, val32, start32, len32)
#define vIO32WriteAPB4BMsk_All(reg32, val32, start32, len32) vIO32WriteAPB4BMsk_All2(p, reg32, val32, start32, len32)
#endif
...
#if ENABLE_APB_MASK_WRITE
#define vIO32WriteAPBFldAlign(reg32,val,fld) /*lint -save -e506 -e504 -e514 -e62 -e737 -e572 -e961 -e648 -e701 -e732 -e571 */ \
	((Fld_ac(fld)==AC_FULLDW)?(vIO32Write4B((reg32),(val))) : (vIO32Write4BAPBMsk((reg32),((U16)(val)),Fld_shft(fld),Fld_wid(fld))) )

#define vIO32WriteAPBFldAlign_All(reg32,val,fld) /*lint -save -e506 -e504 -e514 -e62 -e737 -e572 -e961 -e648 -e701 -e732 -e571 */ \
	((Fld_ac(fld)==AC_FULLDW)?(vIO32Write4B_All((reg32),(val))) : (vIO32WriteAPB4BMsk_All((reg32),((U16)(val)),Fld_shft(fld),Fld_wid(fld))) )
