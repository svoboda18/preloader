...
#define DEVAPC_AO_INFRA_MAS_DOM_0   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1A00))
#define DEVAPC_AO_INFRA_MAS_DOM_1   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1A04))
#define DEVAPC_AO_INFRA_MAS_DOM_2   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1A08))
#define DEVAPC_AO_INFRA_MAS_DOM_3   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1A0C))
#define DEVAPC_AO_INFRA_MAS_DOM_4   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1A10))

#define DEVAPC_AO_INFRA_MAS_SEC_0   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1B00))
#define DEVAPC_AO_INFRA_MAS_SEC_1   ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1B04))
...
#define DEVAPC_AO_INFRA_APC_CON     ((volatile unsigned int*)(DEVAPC_AO_INFRA_BASE+0x1F00))
...
/* domain 10 is across DOM_RMP_0/1 reg */
#define INFRA_AP_HYP            (0x7 << 1)   // EMI MPU domain 11
...
#define MM_SPM                  (0x3 << 18)  //EMI MPU domain 9
