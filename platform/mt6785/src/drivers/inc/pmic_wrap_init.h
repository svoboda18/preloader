...
#define GET_WACS1_INIT_DONE1_SHIFT              (22)
#define GET_SYS_IDLE1_SHIFT                     (23)
...
#define IO_CFG_LM_DRV_CFG1				(IOCFG_LM_BASE+0x010)
#define IO_CFG_LM_DRV_CFG1_SET				(IOCFG_LM_BASE+0x014)
#define IO_CFG_LM_DRV_CFG1_CLR				(IOCFG_LM_BASE+0x018)
