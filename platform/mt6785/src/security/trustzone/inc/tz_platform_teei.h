...
/* UART setting */
#define MT_UART0_IRQ (147)
#define MT_UART1_IRQ (148)
#define MT_UART2_IRQ (149)
#define MT_UART3_IRQ (0)
#define MT_UART0_DAPC (127)
#define MT_UART1_DAPC (128)
#define MT_UART2_DAPC (129)
#define MT_UART3_DAPC (0)

/* Secure Timer setting (SEJ) */
#define MT_SEC_GPT_BASE (0x1000A000)
#define MT_SEC_GPT_IRQ (253)
#define MT_SEC_GPT_DAPC (10)

/* Secure watch Dog setting (SEJ) */
#define MT_SEC_WDT_BASE (0x1000A000)
#define MT_SEC_WDT_IRQ (254)
#define MT_SEC_WDT_DAPC (10)

/* Secure IRQ used in TEE */
#define TEE_FCH_IRQ_NO  (126)
#define TEE_DRV_IRQ_NO  (127)
#define TEE_REV_IRQ_NO  (125)
#define TEE_DUMPER_IRQ_NO  (363)
