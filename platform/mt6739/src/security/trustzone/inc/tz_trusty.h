...
/* to keep trusty load addr at 0x50040000 */
#define TRUSTY_MEM_LOAD_ADDR		(CFG_DRAM_ADDR+ 0x10000000)

#define RPMB_KEY_SIZE     (32)

/* Need to be consistent with definitions in ATF */
typedef struct {
    ...
    u8		 rpmb_key[RPMB_KEY_SIZE];	// rpmb key
} tee_v8_arg_t;
