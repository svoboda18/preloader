...
#define SEC_MEM_RESERVED_SPI_SIZE       (0x100000)//512KB*2 by default
...
#define BL31_DRAM_SIZE                  (0x40000)
/* 64KB by default, only protect atf-reserved-memory */

#define TEE_BOOT_ARG_ADDR               (ATF_BOOT_ARG_ADDR + 0x100)     //base + 0x100

#define TEE_PARAMETER_BASE              (ATF_BOOT_ARG_ADDR)             //base
#define TEE_PARAMETER_ADDR              (TEE_BOOT_ARG_ADDR + 0x100)     //base + 0x200
