...
#ifndef GPIO_KPD_KROW0_PIN_M_KP0ROW
#define GPIO_KPD_KROW0_PIN_M_KP0ROW 0
#endif

#ifndef GPIO_KPD_KROW1_PIN_M_KP1ROW
#define GPIO_KPD_KROW1_PIN_M_KP1ROW 0
#endif

#ifndef GPIO_KPD_KROW2_PIN_M_KP2ROW
#define GPIO_KPD_KROW2_PIN_M_KP2ROW 0
#endif

#ifndef GPIO_KPD_KCOL0_PIN_M_KP0COL
#define GPIO_KPD_KCOL0_PIN_M_KP0COL 0
#endif

#ifndef GPIO_KPD_KCOL1_PIN_M_KP1COL
#define GPIO_KPD_KCOL1_PIN_M_KP1COL 0
#endif

#ifndef GPIO_KPD_KCOL2_PIN_M_KP2COL
#define GPIO_KPD_KCOL2_PIN_M_KP2COL 0
#endif
#endif

void mtk_kpd_gpio_set(void);
extern U32 pmic_read_interface(U32 RegNum, U32 *val, U32 MASK, U32 SHIFT);
bool g_is_kpd_gpio_set = FALSE;
...
void mtk_kpd_gpio_set(void)
{
	...
	if (g_is_kpd_gpio_set) {
		print("mtk_kpd_gpio_set Already!\n");
		return;
	} else {
		g_is_kpd_gpio_set = TRUE;
	}
...
#if CFG_FPGA_PLATFORM
	if ((key == MTK_PMIC_PWR_KEY) || (key == MTK_PMIC_RST_KEY))
		return false;
#endif
