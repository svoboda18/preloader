...
extern int mtk_nand_read_sector_hw(u32 page, u32 sector, u8 * dat, u8 * oob, u8 subpageno);
extern bool nand_block_bad_hw(u64 offset);
extern bool mtk_nand_erase_hw(u64 offset);
