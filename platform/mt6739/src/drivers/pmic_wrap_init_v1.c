...
static void _pwrap_InitStaUpd(void)
{
	...
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_CMD_ADDR, (MT6357_AUXADC_RQST1_SET << 16) + MT6357_AUXADC_RQST0_SET);
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_CMD, (0x0400 << 16) + 0x0080);
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_RDATA_ADDR, (MT6357_AUXADC_ADC38 << 16) + MT6357_AUXADC_ADC18);
...
static void _pwrap_enable(void)
{
		...
		WRAP_WR32(PMIC_WRAP_INT1_EN, 0x000037ff);  /* disable Starvation interrupt for bit 14~31 */
}
...
static int __pwrap_InitSPISLV(void)
{
	...
	pwrap_read_nochk(MT6357_DRV_CON1, &rdata);
	PWRAPLOG("MT6357_DRV_CON1:0x%x\n", rdata);
	pwrap_write_nochk(MT6357_DRV_CON1, 0x8888);
	pwrap_read_nochk(MT6357_DRV_CON1, &rdata);
	PWRAPLOG("MT6357_DRV_CON1:0x%x\n", rdata);
