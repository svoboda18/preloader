...
{
#if !CFG_FPGA_PLATFORM
#ifdef UART_GPIO_HARDCODE
    /* UART0 GPIO default mode is UART, do nothing */
    /* UART1 need hardcode if necessary */
    /* UART2 no need because we only have 2 UART port */
    /* UART3 no need because we only have 2 UART port */
#else
    #ifdef GPIO_UART_UTXD0_PIN
    /* mt_set_gpio_mode(GPIO_UART_UTXD0_PIN, GPIO_UART_UTXD0_PIN_M_UTXD); */
    mt_set_gpio_mode(GPIO_UART_UTXD0_PIN, GPIO_UART_UTXD0_PIN_M_UART0TX);
    ...
    mt_set_gpio_mode(GPIO_UART_URXD0_PIN, GPIO_UART_URXD0_PIN_M_UART0RX);
    ...
    mt_set_gpio_mode(GPIO_UART_UTXD1_PIN, GPIO_UART_UTXD1_PIN_M_UART1TX);
    ...
    mt_set_gpio_mode(GPIO_UART_URXD1_PIN, GPIO_UART_URXD1_PIN_M_UART1TX);
    ...
    mt_set_gpio_mode(GPIO_UART_UTXD2_PIN, GPIO_UART_UTXD2_PIN_M_UART2TX);
    ...
    mt_set_gpio_mode(GPIO_UART_URXD2_PIN, GPIO_UART_URXD2_PIN_M_UART2TX);
    ...
    mt_set_gpio_mode(GPIO_UART_UTXD3_PIN, GPIO_UART_UTXD3_PIN_M_UART3TX);
    ...
    mt_set_gpio_mode(GPIO_UART_URXD3_PIN, GPIO_UART_URXD3_PIN_M_UART3TX);
