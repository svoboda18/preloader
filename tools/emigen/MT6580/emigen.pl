...
# LPDDR3    
	...
	#rank size check END
        ...
        elsif ($DEV_TYPE[$id] eq "Discrete Tablet LPDDR2") # Rainier Tablet 
        {
            $DEV_TYPE1[$id] = "0F" ;
            $DEV_TYPE2[$id] = "02" ;
	    $DIS_LPDDR2 = $DIS_LPDDR2 + 1 ;
        ...
        elsif ($DEV_TYPE[$id] eq "Discrete Tablet LPDDR3") # Rainier Tablet
        {
            $DEV_TYPE1[$id] = "0F" ;
            $DEV_TYPE2[$id] = "03" ;
...
sub write_tag()
{
    ...
    print FILE pack("a24", "MTK_BLOADER_INFO_v21");
...
sub write_tag_one_element_default_LPDDR3()
{
    ...
    if ($DEV_TYPE1[0] eq "0F")
    {
        print FILE pack("L", hex("0x0F03"));                           #type
    }
    else
    {
