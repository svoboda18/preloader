...
#define BOARD_ID                MT6779_EVB

#define CS_PART_NUMBER[0]       KM2V7001CM_B706
#define CS_PART_NUMBER[1]       KM2V7001CM_B706_EMMC
#define CS_PART_NUMBER[2]       KM8V7001JA_B813
#define CS_PART_NUMBER[3]		H9HP52ACPMADAR
#define CS_PART_NUMBER[4]		MT29VZZZAD9DQKSM_046_W_9K9
