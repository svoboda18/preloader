...
#define BOARD_ID                MT6768_EVB

#define CS_PART_NUMBER[0]       H9TQ27ADFTMCUR
#define CS_PART_NUMBER[1]       H9HP52ACPMADAR
#define CS_PART_NUMBER[2]       KM8V7001JA_B813
#define CS_PART_NUMBER[3]       MT29VZZZCD9FQKPR_046W_G9L
