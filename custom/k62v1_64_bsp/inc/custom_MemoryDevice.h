...
#define CS_PART_NUMBER[1]       H9TQ27ADFTMCUR

#define CS_PART_NUMBER[2]       H9TQ17ABJTCCUR
#define CS_PART_NUMBER[3]       MT29TZZZ7D7DKLAH_107
#define CS_PART_NUMBER[4]       KMQE60013M_B318

#define CS_PART_NUMBER[5]       H9HP52ACPMMDAR
#define CS_PART_NUMBER[6]       KMRD60014M_B512
